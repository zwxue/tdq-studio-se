...
//		foreginKeySet.add(createForeignKey2);
		...
		ModelElementChangeRightTarget createModelElementChangeRightTarget = DiffFactoryImpl.eINSTANCE.createModelElementChangeRightTarget();
...
//		Mockito.when(TableHelper.addForeignKey((TdTable)createTdTable, createForeignKey1)).thenReturn(createForeignKey2);
		//~TableHelper
