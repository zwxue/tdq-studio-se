...
public class AlgorithmSwitchTest {
    ...
    public void testGetPreAlgoResult() {
        // LEFT_CHAR
        assertEquals(
                "<test", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LEFT_CHAR.getComponentValueName(), "<", TEST_STR)); //$NON-NLS-1$  //$NON-NLS-2$ 
        ...
        assertEquals(NULL_STR, AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LEFT_CHAR.getComponentValueName(),
                NULL_STR, BLANK_STR));
        assertEquals(
                "\\test", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LEFT_CHAR.getComponentValueName(), "\\", TEST_STR)); //$NON-NLS-1$  //$NON-NLS-2$ 
        ...
        // RIGHT_CHAR
        assertEquals(
                "test<", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.RIGHT_CHAR.getComponentValueName(), "<", TEST_STR)); //$NON-NLS-1$  //$NON-NLS-2$ 
        assertEquals(TEST_STR,
        ...
        assertEquals(
                "test", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LOWER_CASE.getComponentValueName(), null, TEST_STR)); //$NON-NLS-1$
        assertEquals(
                "test\ntest", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LOWER_CASE.getComponentValueName(), null, "Test\ntest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "test\ttest", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LOWER_CASE.getComponentValueName(), null, "Test\ttest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "test test123", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LOWER_CASE.getComponentValueName(), null, "Test test123")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(BLANK_STR,
                AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LOWER_CASE.getComponentValueName(), null, BLANK_STR));
        assertEquals(SPACE_STR,
                AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.LOWER_CASE.getComponentValueName(), null, SPACE_STR));
        ...
        assertEquals(BLANK_STR, AlgorithmSwitch.getPreAlgoResult(
                BlockingKeyPreAlgorithmEnum.REMOVE_MARKS.getComponentValueName(), null, BLANK_STR));
        assertEquals(
                "1-2;40;0-5", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.REMOVE_MARKS.getComponentValueName(), null, "1-2;40;0-5")); //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(
                "Test test", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.REMOVE_MARKS.getComponentValueName(), null, "Test test")); //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(SPACE_STR, AlgorithmSwitch.getPreAlgoResult(
                BlockingKeyPreAlgorithmEnum.REMOVE_MARKS.getComponentValueName(), null, SPACE_STR));
        assertEquals(QUO_STR,
                AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.REMOVE_MARKS.getComponentValueName(), null, QUO_STR));
        ...
        assertEquals(
                "testdtestm", AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.REMOVE_MARKS_THEN_LOWER_CASE.getComponentValueName(), null, "TestDtestM")); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        assertEquals("TEST\nTEST", AlgorithmSwitch.getPreAlgoResult(
                BlockingKeyPreAlgorithmEnum.UPPER_CASE.getComponentValueName(), null, "Test\ntest")); //$NON-NLS-1$ 
        assertEquals("TEST\tTEST", AlgorithmSwitch.getPreAlgoResult(
                BlockingKeyPreAlgorithmEnum.UPPER_CASE.getComponentValueName(), null, "Test\ttest")); //$NON-NLS-1$ 
        assertEquals("TEST TEST12", AlgorithmSwitch.getPreAlgoResult(
                BlockingKeyPreAlgorithmEnum.UPPER_CASE.getComponentValueName(), null, "Test test12")); //$NON-NLS-1$ 
        assertEquals(BLANK_STR,
                AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.UPPER_CASE.getComponentValueName(), null, BLANK_STR));
        assertEquals(SPACE_STR,
                AlgorithmSwitch.getPreAlgoResult(BlockingKeyPreAlgorithmEnum.UPPER_CASE.getComponentValueName(), null, SPACE_STR));
        assertEquals("NULL ",
    ...
    public void testGetAlgoResult() {
        ...
        assertEquals(
                "282", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.COLOGNEPHONETIC.getComponentValueName(), null, TEST_STR)); //$NON-NLS-1$
        assertEquals(BLANK_STR,
                AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.COLOGNEPHONETIC.getComponentValueName(), null, BLANK_STR));
        assertEquals(
                "65", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.COLOGNEPHONETIC.getComponentValueName(), null, NULL_STR)); //$NON-NLS-1$
        assertEquals(BLANK_STR,
        ...
        assertEquals(
                "TST", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.D_METAPHONE.getComponentValueName(), null, TEST_STR)); //$NON-NLS-1$
        assertEquals(null,
                AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.D_METAPHONE.getComponentValueName(), null, BLANK_STR));
        assertEquals(
                "NL", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.D_METAPHONE.getComponentValueName(), null, NULL_STR)); //$NON-NLS-1$
        assertEquals(BLANK_STR,
                AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.D_METAPHONE.getComponentValueName(), null, QUO_STR));

        // EXACT
        assertEquals(BLANK_STR, AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.EXACT.getComponentValueName(), null, null));
        assertEquals(TEST_STR,
        ...
        assertEquals(
                "t", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_CHAR_EW.getComponentValueName(), null, TEST_STR)); //$NON-NLS-1$
        assertEquals(BLANK_STR,
                AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_CHAR_EW.getComponentValueName(), null, BLANK_STR));
        assertEquals(
                "n", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_CHAR_EW.getComponentValueName(), null, NULL_STR)); //$NON-NLS-1$
        assertEquals(QUO_STR,
        ...
        assertEquals(
                "n", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CHAR.getComponentValueName(), "1", NULL_STR)); //$NON-NLS-1$
        assertEquals(QUO_STR,
        ...
        assertEquals(
                "tt", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CHAR_EW.getComponentValueName(), "1", "test\ntest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "tete", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CHAR_EW.getComponentValueName(), "2", "test\ttest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "testes", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CHAR_EW.getComponentValueName(), "3", "test\ftest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "tete", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CHAR_EW.getComponentValueName(), "2", "test test")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "testtest", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CHAR_EW.getComponentValueName(), "4", "test\rtest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(BLANK_STR,
                AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CHAR_EW.getComponentValueName(), "1", BLANK_STR));
        assertEquals(
                "n", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CHAR_EW.getComponentValueName(), "1", NULL_STR)); //$NON-NLS-1$
        assertEquals(QUO_STR,
        ...
        assertEquals(
                "tst", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CONSONANTS.getComponentValueName(), "2000", TEST_STR)); //$NON-NLS-1$
        assertEquals(
                "t", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CONSONANTS.getComponentValueName(), "1", "test\ntest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "ts", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CONSONANTS.getComponentValueName(), "2", "test\ttest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "tstts", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CONSONANTS.getComponentValueName(), "5", "test test")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(BLANK_STR, AlgorithmSwitch.getAlgoResult(
                BlockingKeyAlgorithmEnum.FIRST_N_CONSONANTS.getComponentValueName(), "1", BLANK_STR));
        assertEquals(BLANK_STR, AlgorithmSwitch.getAlgoResult(
                BlockingKeyAlgorithmEnum.FIRST_N_CONSONANTS.getComponentValueName(), "1", SPACE_STR));
        assertEquals(
                "n", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_CONSONANTS.getComponentValueName(), "1", NULL_STR)); //$NON-NLS-1$
        assertEquals(BLANK_STR,
        ...
        assertEquals(
                "e", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_VOWELS.getComponentValueName(), "2000", TEST_STR)); //$NON-NLS-1$
        assertEquals(
                "e", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_VOWELS.getComponentValueName(), "1", "test\ntest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "ee", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_VOWELS.getComponentValueName(), "2", "test\ttest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "ee", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_VOWELS.getComponentValueName(), "5", "test test")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(BLANK_STR,
        ...
        assertEquals(
                "u", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.FIRST_N_VOWELS.getComponentValueName(), "1", NULL_STR)); //$NON-NLS-1$
        assertEquals(BLANK_STR,
        ...
        assertEquals(
                "test", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.LAST_N_CHAR.getComponentValueName(), "2000", TEST_STR)); //$NON-NLS-1$
        assertEquals(
                "t", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.LAST_N_CHAR.getComponentValueName(), "1", "test\ntest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                "st", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.LAST_N_CHAR.getComponentValueName(), "2", "test\ttest")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(
                " test", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.LAST_N_CHAR.getComponentValueName(), "5", "test test")); //$NON-NLS-1$ //$NON-NLS-2$ 
        assertEquals(BLANK_STR,
        ...
        assertEquals(
                "l", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.LAST_N_CHAR.getComponentValueName(), "1", NULL_STR)); //$NON-NLS-1$
        assertEquals(QUO_STR,
        ...
        assertEquals(
                "TST", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.METAPHONE.getComponentValueName(), null, TEST_STR)); //$NON-NLS-1$
        assertEquals(
                "TSTT", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.METAPHONE.getComponentValueName(), null, "Test\ntest")); //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(
                "TSTT", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.METAPHONE.getComponentValueName(), null, "Test\ttest")); //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(
                "TSTT", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.METAPHONE.getComponentValueName(), null, "Test test123t")); //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(BLANK_STR,
        ...
        assertEquals(
                "NL", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.METAPHONE.getComponentValueName(), null, "Null")); //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(QUO_STR,
        ...
        assertEquals(
                "etest", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.PICK_CHAR.getComponentValueName(), "1-2;40;0-5", TEST_STR)); //$NON-NLS-1$  //$NON-NLS-2$
        assertEquals(
                "e", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.PICK_CHAR.getComponentValueName(), "1-2", "Test test")); //$NON-NLS-1$  //$NON-NLS-2$  //$NON-NLS-3$
        assertEquals(BLANK_STR,
        ...
        assertEquals(
                "T230", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.SOUNDEX.getComponentValueName(), null, TEST_STR)); //$NON-NLS-1$
        assertEquals(BLANK_STR,
                AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.SOUNDEX.getComponentValueName(), null, BLANK_STR));
        assertEquals(
                "T232", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.SOUNDEX.getComponentValueName(), null, "Test test")); //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(BLANK_STR,
        ...
        assertEquals(
                "est", AlgorithmSwitch.getAlgoResult(BlockingKeyAlgorithmEnum.SUBSTR.getComponentValueName(), "1;100", TEST_STR)); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testGetPostAlgoResult() {
        ...
        assertEquals(TEST_STR, AlgorithmSwitch.getPostAlgoResult(
                BlockingKeyPostAlgorithmEnum.USE_DEFAULT.getComponentValueName(), TEST_STR, null));
        assertEquals(TEST_STR, AlgorithmSwitch.getPostAlgoResult(
                BlockingKeyPostAlgorithmEnum.USE_DEFAULT.getComponentValueName(), SPACE_STR, TEST_STR));
        assertEquals(
                "Test test12", AlgorithmSwitch.getPostAlgoResult(BlockingKeyPostAlgorithmEnum.USE_DEFAULT.getComponentValueName(), NULL_STR, "Test test12")); //$NON-NLS-1$ //$NON-NLS-2$
    }
