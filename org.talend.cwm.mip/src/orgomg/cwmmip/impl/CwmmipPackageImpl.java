...
public class CwmmipPackageImpl extends EPackageImpl implements CwmmipPackage {
    ...
    public static CwmmipPackage init() {
        ...
        CwmmipPackageImpl theCwmmipPackage = (CwmmipPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof CwmmipPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new CwmmipPackageImpl());
