 ...
 * <ul>
 *   <li>{@link orgomg.cwmx.resource.express.impl.ConjointImpl#getSearchAlgorithm <em>Search Algorithm</em>}</li>
 *   <li>{@link orgomg.cwmx.resource.express.impl.ConjointImpl#getPageSpace <em>Page Space</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConjointImpl extends DimensionImpl implements Conjoint {
    ...
    protected EClass eStaticClass() {
        return ExpressPackage.Literals.CONJOINT;
    }
    ...
    public void setPageSpace(String newPageSpace) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExpressPackage.CONJOINT__PAGE_SPACE, oldPageSpace, pageSpace));
    }
