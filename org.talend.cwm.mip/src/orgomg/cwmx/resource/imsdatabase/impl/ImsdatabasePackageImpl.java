...
public class ImsdatabasePackageImpl extends EPackageImpl implements ImsdatabasePackage {
    ...
    public static ImsdatabasePackage init() {
        ...
        ImsdatabasePackageImpl theImsdatabasePackage = (ImsdatabasePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ImsdatabasePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ImsdatabasePackageImpl());
