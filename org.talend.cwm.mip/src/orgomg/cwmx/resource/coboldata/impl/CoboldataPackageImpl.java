...
public class CoboldataPackageImpl extends EPackageImpl implements CoboldataPackage {
     ...
     * 
     * <p>This method is used to initialize {@link CoboldataPackage#eINSTANCE} when that field is accessed.
    ...
    public static CoboldataPackage init() {
        ...
        CoboldataPackageImpl theCoboldataPackage = (CoboldataPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CoboldataPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CoboldataPackageImpl());
        ...
        EPackage.Registry.INSTANCE.put(CoboldataPackage.eNS_URI, theCoboldataPackage);
