 ...
 * @generated
 */
public class InformationreportingPackageImpl extends EPackageImpl implements InformationreportingPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @generated
     */
    private EClass reportExecutionEClass = null;
     ...
     * @generated
     */
    private EClass reportFieldEClass = null;
     ...
     * @generated
     */
    private EEnum reportGroupTypeEEnum = null;
     ...
     * @see orgomg.cwmx.analysis.informationreporting.InformationreportingPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private InformationreportingPackageImpl() {
        super(eNS_URI, InformationreportingFactory.eINSTANCE);
    }
     ...
     * 
     * <p>This method is used to initialize {@link InformationreportingPackage#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static InformationreportingPackage init() {
        if (isInited) return (InformationreportingPackage)EPackage.Registry.INSTANCE.getEPackage(InformationreportingPackage.eNS_URI);

        // Obtain or create and register package
        InformationreportingPackageImpl theInformationreportingPackage = (InformationreportingPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InformationreportingPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InformationreportingPackageImpl());
        ...
        theInformationreportingPackage.freeze();

  
        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(InformationreportingPackage.eNS_URI, theInformationreportingPackage);
        return theInformationreportingPackage;
    }
     ...
     * @generated
     */
    public EClass getReportExecution() {
        return reportExecutionEClass;
    }
     ...
     * @generated
     */
    public EClass getReportField() {
        return reportFieldEClass;
    }
     ...
     * @generated
     */
    public EAttribute getReportGroup_GroupType() {
     ...
     * @generated
     */
    public EReference getReportGroup_ReportQuery() {
     ...
     * @generated
     */
    public EEnum getReportGroupType() {
        return reportGroupTypeEEnum;
    }
     ...
     * @generated
     */
    public InformationreportingFactory getInformationreportingFactory() {
        return (InformationreportingFactory)getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        reportAttributeEClass = createEClass(REPORT_ATTRIBUTE);

        reportExecutionEClass = createEClass(REPORT_EXECUTION);

        reportFieldEClass = createEClass(REPORT_FIELD);

        reportGroupEClass = createEClass(REPORT_GROUP);
        createEAttribute(reportGroupEClass, REPORT_GROUP__GROUP_TYPE);
        createEReference(reportGroupEClass, REPORT_GROUP__REPORT_QUERY);

        reportPackageEClass = createEClass(REPORT_PACKAGE);

        // Create enums
        reportGroupTypeEEnum = createEEnum(REPORT_GROUP_TYPE);
    }
    ...
    public void initializePackageContents() {
        ...
        reportEClass.getESuperTypes().add(theInformationvisualizationPackage.getRenderedObject());
        reportAttributeEClass.getESuperTypes().add(theCorePackage.getAttribute());
        reportExecutionEClass.getESuperTypes().add(theTransformationPackage.getTransformationMap());
        reportFieldEClass.getESuperTypes().add(theInformationvisualizationPackage.getRenderedObject());
        reportGroupEClass.getESuperTypes().add(theInformationvisualizationPackage.getRenderedObject());
        reportPackageEClass.getESuperTypes().add(theInformationvisualizationPackage.getRenderedObjectSet());

        // Initialize classes and features; add operations and parameters
        initEClass(reportEClass, Report.class, "Report", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(reportAttributeEClass, ReportAttribute.class, "ReportAttribute", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(reportExecutionEClass, ReportExecution.class, "ReportExecution", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(reportFieldEClass, ReportField.class, "ReportField", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(reportGroupEClass, ReportGroup.class, "ReportGroup", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getReportGroup_GroupType(), this.getReportGroupType(), "groupType", null, 0, 1, ReportGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getReportGroup_ReportQuery(), theDatatypesPackage.getQueryExpression(), theDatatypesPackage.getQueryExpression_ReportGroup(), "reportQuery", null, 0, -1, ReportGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEEnum(reportGroupTypeEEnum, ReportGroupType.class, "ReportGroupType");
        addEEnumLiteral(reportGroupTypeEEnum, ReportGroupType.HEADER);
        addEEnumLiteral(reportGroupTypeEEnum, ReportGroupType.FOOTER);
        addEEnumLiteral(reportGroupTypeEEnum, ReportGroupType.DETAIL);
        addEEnumLiteral(reportGroupTypeEEnum, ReportGroupType.OTHER);

        // Create resource
        createResource(eNS_URI);
    }

} //InformationreportingPackageImpl
