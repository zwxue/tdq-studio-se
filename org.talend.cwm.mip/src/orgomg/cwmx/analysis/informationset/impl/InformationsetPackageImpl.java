 ...
 * @generated
 */
public class InformationsetPackageImpl extends EPackageImpl implements InformationsetPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private EClass informationSetEClass = null;
     ...
     * @generated
     */
    private EClass segmentRegionEClass = null;
     ...
     * @generated
     */
    private EClass infoSetAdministrationEClass = null;
     ...
     * @generated
     */
    private EClass infoSetDateEClass = null;
     ...
     * @see orgomg.cwmx.analysis.informationset.InformationsetPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private InformationsetPackageImpl() {
        super(eNS_URI, InformationsetFactory.eINSTANCE);
    }
     ...
     * 
     * <p>This method is used to initialize {@link InformationsetPackage#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static InformationsetPackage init() {
        if (isInited) return (InformationsetPackage)EPackage.Registry.INSTANCE.getEPackage(InformationsetPackage.eNS_URI);

        // Obtain or create and register package
        InformationsetPackageImpl theInformationsetPackage = (InformationsetPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof InformationsetPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new InformationsetPackageImpl());
        ...
        theInformationsetPackage.freeze();

  
        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(InformationsetPackage.eNS_URI, theInformationsetPackage);
        return theInformationsetPackage;
    }
     ...
     * @generated
     */
    public EClass getInformationSet() {
        return informationSetEClass;
    }
     ...
     * @generated
     */
    public EAttribute getInformationSet_Version() {
        return (EAttribute)informationSetEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EReference getInformationSet_Rule() {
        return (EReference)informationSetEClass.getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public EReference getInformationSet_InfoSetAdmin() {
        return (EReference)informationSetEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EReference getSegment_RegionSequence() {
     ...
     * @generated
     */
    public EReference getSegment_Rule() {
     ...
     * @generated
     */
    public EClass getSegmentRegion() {
        return segmentRegionEClass;
    }
     ...
     * @generated
     */
    public EReference getSegmentRegion_Rule() {
        return (EReference)segmentRegionEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EReference getRule_RuleExpression() {
     ...
     * @generated
     */
    public EReference getRule_InformationSet() {
     ...
     * @generated
     */
    public EReference getRule_Segment() {
     ...
     * @generated
     */
    public EReference getRule_SegmentRegion() {
     ...
     * @generated
     */
    public EClass getInfoSetAdministration() {
        return infoSetAdministrationEClass;
    }
     ...
     * @generated
     */
    public EAttribute getInfoSetAdministration_Priority() {
        return (EAttribute)infoSetAdministrationEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EAttribute getInfoSetAdministration_Acknowledgement() {
        return (EAttribute)infoSetAdministrationEClass.getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public EReference getInfoSetAdministration_InformationSet() {
        return (EReference)infoSetAdministrationEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EReference getInfoSetAdministration_Date() {
        return (EReference)infoSetAdministrationEClass.getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public EClass getInfoSetDate() {
        return infoSetDateEClass;
    }
     ...
     * @generated
     */
    public EAttribute getInfoSetDate_Type() {
        return (EAttribute)infoSetDateEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EAttribute getInfoSetDate_Format() {
        return (EAttribute)infoSetDateEClass.getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public EAttribute getInfoSetDate_DateTime() {
        return (EAttribute)infoSetDateEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EReference getInfoSetDate_InfoSetAdmin() {
        return (EReference)infoSetDateEClass.getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public InformationsetFactory getInformationsetFactory() {
        return (InformationsetFactory)getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        informationSetEClass = createEClass(INFORMATION_SET);
        createEAttribute(informationSetEClass, INFORMATION_SET__VERSION);
        createEReference(informationSetEClass, INFORMATION_SET__RULE);
        createEReference(informationSetEClass, INFORMATION_SET__INFO_SET_ADMIN);

        segmentEClass = createEClass(SEGMENT);
        createEReference(segmentEClass, SEGMENT__REGION_SEQUENCE);
        createEReference(segmentEClass, SEGMENT__RULE);

        segmentRegionEClass = createEClass(SEGMENT_REGION);
        createEReference(segmentRegionEClass, SEGMENT_REGION__RULE);

        ruleEClass = createEClass(RULE);
        createEReference(ruleEClass, RULE__RULE_EXPRESSION);
        createEAttribute(ruleEClass, RULE__TYPE);
        createEReference(ruleEClass, RULE__INFORMATION_SET);
        createEReference(ruleEClass, RULE__SEGMENT);
        createEReference(ruleEClass, RULE__SEGMENT_REGION);

        infoSetAdministrationEClass = createEClass(INFO_SET_ADMINISTRATION);
        createEAttribute(infoSetAdministrationEClass, INFO_SET_ADMINISTRATION__PRIORITY);
        createEAttribute(infoSetAdministrationEClass, INFO_SET_ADMINISTRATION__ACKNOWLEDGEMENT);
        createEReference(infoSetAdministrationEClass, INFO_SET_ADMINISTRATION__INFORMATION_SET);
        createEReference(infoSetAdministrationEClass, INFO_SET_ADMINISTRATION__DATE);

        infoSetDateEClass = createEClass(INFO_SET_DATE);
        createEAttribute(infoSetDateEClass, INFO_SET_DATE__TYPE);
        createEAttribute(infoSetDateEClass, INFO_SET_DATE__FORMAT);
        createEAttribute(infoSetDateEClass, INFO_SET_DATE__DATE_TIME);
        createEReference(infoSetDateEClass, INFO_SET_DATE__INFO_SET_ADMIN);
    }
    ...
    public void initializePackageContents() {
        ...
        informationSetEClass.getESuperTypes().add(theOlapPackage.getSchema());
        segmentEClass.getESuperTypes().add(theOlapPackage.getCube());
        segmentRegionEClass.getESuperTypes().add(theOlapPackage.getCubeRegion());
        ruleEClass.getESuperTypes().add(theCorePackage.getModelElement());
        infoSetAdministrationEClass.getESuperTypes().add(theCorePackage.getModelElement());
        infoSetDateEClass.getESuperTypes().add(theCorePackage.getModelElement());

        // Initialize classes and features; add operations and parameters
        initEClass(informationSetEClass, InformationSet.class, "InformationSet", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getInformationSet_Version(), theCorePackage.getString(), "version", null, 0, 1, InformationSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getInformationSet_Rule(), this.getRule(), this.getRule_InformationSet(), "rule", null, 0, -1, InformationSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getInformationSet_InfoSetAdmin(), this.getInfoSetAdministration(), this.getInfoSetAdministration_InformationSet(), "infoSetAdmin", null, 0, -1, InformationSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(segmentEClass, Segment.class, "Segment", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSegment_RegionSequence(), theCorePackage.getProcedureExpression(), null, "regionSequence", null, 0, 1, Segment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getSegment_Rule(), this.getRule(), this.getRule_Segment(), "rule", null, 0, -1, Segment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(segmentRegionEClass, SegmentRegion.class, "SegmentRegion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSegmentRegion_Rule(), this.getRule(), this.getRule_SegmentRegion(), "rule", null, 0, -1, SegmentRegion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(ruleEClass, Rule.class, "Rule", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getRule_RuleExpression(), theExpressionsPackage.getExpressionNode(), null, "ruleExpression", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getRule_Type(), theCorePackage.getString(), "type", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRule_InformationSet(), this.getInformationSet(), this.getInformationSet_Rule(), "informationSet", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRule_Segment(), this.getSegment(), this.getSegment_Rule(), "segment", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getRule_SegmentRegion(), this.getSegmentRegion(), this.getSegmentRegion_Rule(), "segmentRegion", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(infoSetAdministrationEClass, InfoSetAdministration.class, "InfoSetAdministration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getInfoSetAdministration_Priority(), theCorePackage.getString(), "priority", null, 0, 1, InfoSetAdministration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInfoSetAdministration_Acknowledgement(), theCorePackage.getBoolean(), "acknowledgement", null, 0, 1, InfoSetAdministration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getInfoSetAdministration_InformationSet(), this.getInformationSet(), this.getInformationSet_InfoSetAdmin(), "informationSet", null, 1, 1, InfoSetAdministration.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getInfoSetAdministration_Date(), this.getInfoSetDate(), this.getInfoSetDate_InfoSetAdmin(), "date", null, 0, -1, InfoSetAdministration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(infoSetDateEClass, InfoSetDate.class, "InfoSetDate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getInfoSetDate_Type(), theCorePackage.getString(), "type", null, 0, 1, InfoSetDate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInfoSetDate_Format(), theCorePackage.getString(), "format", null, 0, 1, InfoSetDate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getInfoSetDate_DateTime(), theCorePackage.getString(), "dateTime", null, 0, 1, InfoSetDate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getInfoSetDate_InfoSetAdmin(), this.getInfoSetAdministration(), this.getInfoSetAdministration_Date(), "infoSetAdmin", null, 1, -1, InfoSetDate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        // Create resource
        createResource(eNS_URI);
    }

} //InformationsetPackageImpl
