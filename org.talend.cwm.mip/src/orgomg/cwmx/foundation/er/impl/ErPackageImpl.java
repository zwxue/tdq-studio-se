...
public class ErPackageImpl extends EPackageImpl implements ErPackage {
    ...
    public static ErPackage init() {
        ...
        ErPackageImpl theErPackage = (ErPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ErPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ErPackageImpl());
