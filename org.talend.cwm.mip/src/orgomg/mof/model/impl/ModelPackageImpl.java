...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
     ...
     * @see orgomg.mof.model.ModelPackage#eNS_URI
     * @see #init()
     * @generated
     */
     ...
     * @generated
     */
    public EReference getModelElement_ModeledGraphSubset() {
     ...
     * @generated
     */
    public EReference getModelElement_ModeledProjection() {
     ...
     * @generated
     */
    public EReference getModelElement_ModeledSemanticContext() {
     ...
     * @generated
     */
    public EReference getAssociation_ModeledProjection() {
    ...
    public void createPackageContents() {
        ...
        createEReference(modelElementEClass, MODEL_ELEMENT__MODELED_GRAPH_SUBSET);
        createEReference(modelElementEClass, MODEL_ELEMENT__MODELED_PROJECTION);
        createEReference(modelElementEClass, MODEL_ELEMENT__MODELED_SEMANTIC_CONTEXT);

        associationEClass = createEClass(ASSOCIATION);
        createEReference(associationEClass, ASSOCIATION__MODELED_PROJECTION);
    }
    ...
    public void initializePackageContents() {
        ...
        CwmmipPackage theCwmmipPackage = (CwmmipPackage)EPackage.Registry.INSTANCE.getEPackage(CwmmipPackage.eNS_URI);
        ...
        initEReference(getModelElement_ModeledGraphSubset(), theCwmmipPackage.getModeledGraphSubset(), theCwmmipPackage.getModeledGraphSubset_MofElement(), "modeledGraphSubset", null, 0, -1, ModelElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getModelElement_ModeledProjection(), theCwmmipPackage.getModeledSemanticContext(), theCwmmipPackage.getModeledSemanticContext_MofElement(), "modeledProjection", null, 0, -1, ModelElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getModelElement_ModeledSemanticContext(), theCwmmipPackage.getModeledSemanticContext(), theCwmmipPackage.getModeledSemanticContext_MofAnchorElement(), "modeledSemanticContext", null, 0, -1, ModelElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(associationEClass, Association.class, "Association", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getAssociation_ModeledProjection(), theCwmmipPackage.getModeledSemanticContext(), theCwmmipPackage.getModeledSemanticContext_MofAssociation(), "modeledProjection", null, 0, -1, Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
