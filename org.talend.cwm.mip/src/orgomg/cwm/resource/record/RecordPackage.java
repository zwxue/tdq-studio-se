...
public interface RecordPackage extends EPackage {
     ...
     * @ordered
     */
    int FIELD__REMAP = CorePackage.ATTRIBUTE__REMAP;
     ...
     * @ordered
     */
    int RECORD_DEF__DASDL_PROPERTY = CorePackage.CLASS__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int RECORD_DEF__DOMAIN = CorePackage.CLASS__DOMAIN;
     ...
     * @ordered
     */
    int RECORD_DEF_FEATURE_COUNT = CorePackage.CLASS_FEATURE_COUNT + 5;
     ...
     * @ordered
     */
    int FIXED_OFFSET_FIELD__REMAP = FIELD__REMAP;
     ...
     * @ordered
     */
    int RECORD_FILE__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int RECORD_SET__DASDL_PROPERTY = InstancePackage.EXTENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int GROUP__DASDL_PROPERTY = CorePackage.CLASSIFIER__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int GROUP__DOMAIN = CorePackage.CLASSIFIER__DOMAIN;
