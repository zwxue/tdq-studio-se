...
public class RecordSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case RecordPackage.RECORD_DEF: {
                ...
                if (result == null) result = caseClass(recordDef);
                if (result == null) result = caseClassifier(recordDef);
                if (result == null) result = caseNamespace(recordDef);
                if (result == null) result = caseModelElement(recordDef);
                if (result == null) result = caseElement(recordDef);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RecordPackage.FIXED_OFFSET_FIELD: {
                FixedOffsetField fixedOffsetField = (FixedOffsetField)theEObject;
                T result = caseFixedOffsetField(fixedOffsetField);
                if (result == null) result = caseField(fixedOffsetField);
                if (result == null) result = caseAttribute(fixedOffsetField);
                if (result == null) result = caseStructuralFeature(fixedOffsetField);
                if (result == null) result = caseFeature(fixedOffsetField);
                if (result == null) result = caseModelElement(fixedOffsetField);
                if (result == null) result = caseElement(fixedOffsetField);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RecordPackage.RECORD_FILE: {
                ...
                if (result == null) result = casePackage(recordFile);
                if (result == null) result = caseNamespace(recordFile);
            ...
            case RecordPackage.FIELD_VALUE: {
                ...
                if (result == null) result = caseDataValue(fieldValue);
                if (result == null) result = caseInstance(fieldValue);
                if (result == null) result = caseModelElement(fieldValue);
                if (result == null) result = caseElement(fieldValue);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RecordPackage.RECORD: {
                ...
                if (result == null) result = caseObject(record);
                if (result == null) result = caseInstance(record);
            ...
            case RecordPackage.RECORD_SET: {
                RecordSet recordSet = (RecordSet)theEObject;
                T result = caseRecordSet(recordSet);
                if (result == null) result = caseExtent(recordSet);
                if (result == null) result = casePackage(recordSet);
                if (result == null) result = caseNamespace(recordSet);
                if (result == null) result = caseModelElement(recordSet);
                if (result == null) result = caseElement(recordSet);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case RecordPackage.GROUP: {
                ...
                if (result == null) result = caseClassifier(group);
                if (result == null) result = caseNamespace(group);
     ...
     * @generated
     */
    public T caseRecordSet(RecordSet object) {
        return null;
    }
