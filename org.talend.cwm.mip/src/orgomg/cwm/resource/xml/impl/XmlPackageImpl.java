...
public class XmlPackageImpl extends EPackageImpl implements XmlPackage {
     ...
     * @see orgomg.cwm.resource.xml.XmlPackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public static XmlPackage init() {
        ...
        XmlPackageImpl theXmlPackage = (XmlPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof XmlPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new XmlPackageImpl());
    ...
    public void initializePackageContents() {
        ...
        elementEClass.getESuperTypes().add(theInstancePackage.getObject());
        documentEClass.getESuperTypes().add(theInstancePackage.getExtent());

        // Initialize classes and features; add operations and parameters
        initEClass(schemaEClass, Schema.class, "Schema", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getSchema_Version(), theCorePackage.getString(), "version", null, 0, 1, Schema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getSchema_XmlNamespace(), theCorePackage.getString(), "xmlNamespace", null, 0, 1, Schema.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getAttribute_DefaultKind(), this.getAttributeDefault(), "defaultKind", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(contentEClass, Content.class, "Content", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getContent_Type(), this.getContentType(), "type", null, 0, 1, Content.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getContent_Occurrence(), this.getOccurrenceType(), "occurrence", null, 0, 1, Content.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getElementContent_Order(), this.getElementOrderType(), "order", null, 0, 1, ElementContent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getElementTypeReference_Occurrence(), this.getOccurrenceType(), "occurrence", null, 0, 1, ElementTypeReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
