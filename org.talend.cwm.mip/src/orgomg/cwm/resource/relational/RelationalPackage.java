...
public interface RelationalPackage extends EPackage {
     ...
     * @ordered
     */
    int CATALOG__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int COLUMN_SET__DASDL_PROPERTY = CorePackage.CLASS__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int COLUMN_SET__DOMAIN = CorePackage.CLASS__DOMAIN;
     ...
     * @ordered
     */
    int COLUMN_SET__SIMPLE_DIMENSION = CorePackage.CLASS__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int NAMED_COLUMN_SET__DASDL_PROPERTY = COLUMN_SET__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int NAMED_COLUMN_SET__DOMAIN = COLUMN_SET__DOMAIN;
     ...
     * @ordered
     */
    int NAMED_COLUMN_SET__SIMPLE_DIMENSION = COLUMN_SET__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int TABLE__DASDL_PROPERTY = NAMED_COLUMN_SET__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TABLE__DOMAIN = NAMED_COLUMN_SET__DOMAIN;
     ...
     * @ordered
     */
    int TABLE__SIMPLE_DIMENSION = NAMED_COLUMN_SET__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int VIEW__DASDL_PROPERTY = NAMED_COLUMN_SET__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int VIEW__DOMAIN = NAMED_COLUMN_SET__DOMAIN;
     ...
     * @ordered
     */
    int VIEW__SIMPLE_DIMENSION = NAMED_COLUMN_SET__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int QUERY_COLUMN_SET__DASDL_PROPERTY = COLUMN_SET__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int QUERY_COLUMN_SET__DOMAIN = COLUMN_SET__DOMAIN;
     ...
     * @ordered
     */
    int QUERY_COLUMN_SET__SIMPLE_DIMENSION = COLUMN_SET__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int SQL_DATA_TYPE__DASDL_PROPERTY = CorePackage.CLASSIFIER__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SQL_DATA_TYPE__DOMAIN = CorePackage.CLASSIFIER__DOMAIN;
     ...
     * @ordered
     */
    int SQL_DATA_TYPE__SIMPLE_DIMENSION = CorePackage.CLASSIFIER__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int SQL_DISTINCT_TYPE__DASDL_PROPERTY = SQL_DATA_TYPE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SQL_DISTINCT_TYPE__DOMAIN = SQL_DATA_TYPE__DOMAIN;
     ...
     * @ordered
     */
    int SQL_DISTINCT_TYPE__SIMPLE_DIMENSION = SQL_DATA_TYPE__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int SQL_SIMPLE_TYPE__DASDL_PROPERTY = SQL_DATA_TYPE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SQL_SIMPLE_TYPE__DOMAIN = SQL_DATA_TYPE__DOMAIN;
     ...
     * @ordered
     */
    int SQL_SIMPLE_TYPE__SIMPLE_DIMENSION = SQL_DATA_TYPE__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int SQL_STRUCTURED_TYPE__DASDL_PROPERTY = CorePackage.CLASS__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SQL_STRUCTURED_TYPE__DOMAIN = CorePackage.CLASS__DOMAIN;
     ...
     * @ordered
     */
    int SQL_STRUCTURED_TYPE__SIMPLE_DIMENSION = CorePackage.CLASS__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int COLUMN__DASDL_PROPERTY = CorePackage.ATTRIBUTE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int COLUMN__DATA_ITEM = CorePackage.ATTRIBUTE__DATA_ITEM;
     ...
     * @ordered
     */
    int COLUMN__REMAP = CorePackage.ATTRIBUTE__REMAP;
     ...
     * @ordered
     */
    int PROCEDURE__DASDL_PROPERTY = BehavioralPackage.METHOD__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TRIGGER__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SQL_INDEX__DASDL_PROPERTY = KeysindexesPackage.INDEX__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int UNIQUE_CONSTRAINT__DASDL_PROPERTY = KeysindexesPackage.UNIQUE_KEY__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SQL_INDEX_COLUMN__DASDL_PROPERTY = KeysindexesPackage.INDEXED_FEATURE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int PRIMARY_KEY__DASDL_PROPERTY = UNIQUE_CONSTRAINT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int ROW__DASDL_PROPERTY = InstancePackage.OBJECT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int COLUMN_VALUE__DASDL_PROPERTY = InstancePackage.DATA_VALUE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CHECK_CONSTRAINT__DASDL_PROPERTY = CorePackage.CONSTRAINT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int ROW_SET__DASDL_PROPERTY = InstancePackage.EXTENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SQL_PARAMETER__DASDL_PROPERTY = BehavioralPackage.PARAMETER__DASDL_PROPERTY;
