...
public class MultidimensionalPackageImpl extends EPackageImpl implements MultidimensionalPackage {
     ...
     * @see orgomg.cwm.resource.multidimensional.MultidimensionalPackage#eNS_URI
     * @see #init()
     * @generated
     */
     ...
     * 
     * <p>This method is used to initialize {@link MultidimensionalPackage#eINSTANCE} when that field is accessed.
    ...
    public static MultidimensionalPackage init() {
        ...
        MultidimensionalPackageImpl theMultidimensionalPackage = (MultidimensionalPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MultidimensionalPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MultidimensionalPackageImpl());
        ...
        EPackage.Registry.INSTANCE.put(MultidimensionalPackage.eNS_URI, theMultidimensionalPackage);
    ...
    public void initializePackageContents() {
        ...
        memberEClass.getESuperTypes().add(theInstancePackage.getObject());
        memberSetEClass.getESuperTypes().add(theInstancePackage.getExtent());
        memberValueEClass.getESuperTypes().add(theInstancePackage.getDataValue());
