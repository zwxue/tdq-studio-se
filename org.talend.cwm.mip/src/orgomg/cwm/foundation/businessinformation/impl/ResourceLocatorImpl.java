 ...
 * <ul>
 *   <li>{@link orgomg.cwm.foundation.businessinformation.impl.ResourceLocatorImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link orgomg.cwm.foundation.businessinformation.impl.ResourceLocatorImpl#getContact <em>Contact</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceLocatorImpl extends ModelElementImpl implements ResourceLocator {
    ...
    protected EClass eStaticClass() {
        return BusinessinformationPackage.Literals.RESOURCE_LOCATOR;
    }
    ...
    public void setUrl(String newUrl) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, BusinessinformationPackage.RESOURCE_LOCATOR__URL, oldUrl, url));
    }
