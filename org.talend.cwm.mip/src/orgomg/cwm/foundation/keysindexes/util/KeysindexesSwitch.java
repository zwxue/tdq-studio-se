 ...
 * $Id$
 */
package orgomg.cwm.foundation.keysindexes.util;
 ...
 * @generated
 */
public class KeysindexesSwitch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case KeysindexesPackage.KEY_RELATIONSHIP: {
                KeyRelationship keyRelationship = (KeyRelationship)theEObject;
                T result = caseKeyRelationship(keyRelationship);
                if (result == null) result = caseModelElement(keyRelationship);
                if (result == null) result = caseElement(keyRelationship);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case KeysindexesPackage.INDEXED_FEATURE: {
                IndexedFeature indexedFeature = (IndexedFeature)theEObject;
                T result = caseIndexedFeature(indexedFeature);
                if (result == null) result = caseModelElement(indexedFeature);
                if (result == null) result = caseElement(indexedFeature);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
