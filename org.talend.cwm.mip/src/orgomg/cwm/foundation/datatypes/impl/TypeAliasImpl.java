 ...
 * <ul>
 *   <li>{@link orgomg.cwm.foundation.datatypes.impl.TypeAliasImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeAliasImpl extends DataTypeImpl implements TypeAlias {
    ...
    public NotificationChain basicSetType(Classifier newType, NotificationChain msgs) {
        ...
        type = newType;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DatatypesPackage.TYPE_ALIAS__TYPE, oldType, newType);
    ...
    public void setType(Classifier newType) {
        if (newType != type) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.TYPE_ALIAS__TYPE, newType, newType));
    }
