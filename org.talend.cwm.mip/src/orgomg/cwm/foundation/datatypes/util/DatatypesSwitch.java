    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case DatatypesPackage.QUERY_EXPRESSION: {
                ...
                if (result == null) result = caseProcedureExpression(queryExpression);
                if (result == null) result = caseExpression(queryExpression);
                if (result == null) result = caseElement(queryExpression);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case DatatypesPackage.TYPE_ALIAS: {
                ...
                if (result == null) result = caseDataType(typeAlias);
                if (result == null) result = caseClassifier(typeAlias);
                if (result == null) result = caseNamespace(typeAlias);
                if (result == null) result = caseModelElement(typeAlias);
                if (result == null) result = caseElement(typeAlias);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            ...
            case DatatypesPackage.UNION_MEMBER: {
                ...
                if (result == null) result = caseAttribute(unionMember);
                if (result == null) result = caseStructuralFeature(unionMember);
                if (result == null) result = caseFeature(unionMember);
                if (result == null) result = caseModelElement(unionMember);
                if (result == null) result = caseElement(unionMember);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
