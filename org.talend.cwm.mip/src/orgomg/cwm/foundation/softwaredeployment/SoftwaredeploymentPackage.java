...
public interface SoftwaredeploymentPackage extends EPackage {
     ...
     * @ordered
     */
    int MACHINE__DASDL_PROPERTY = CorePackage.NAMESPACE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SOFTWARE_SYSTEM__DASDL_PROPERTY = CorePackage.SUBSYSTEM__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SOFTWARE_SYSTEM__DOMAIN = CorePackage.SUBSYSTEM__DOMAIN;
     ...
     * @ordered
     */
    int SOFTWARE_SYSTEM__SIMPLE_DIMENSION = CorePackage.SUBSYSTEM__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int DEPLOYED_COMPONENT__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int DEPLOYED_SOFTWARE_SYSTEM__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int DATA_MANAGER__DASDL_PROPERTY = DEPLOYED_COMPONENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int DATA_PROVIDER__DASDL_PROPERTY = DATA_MANAGER__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int COMPONENT__DASDL_PROPERTY = CorePackage.CLASSIFIER__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int COMPONENT__DOMAIN = CorePackage.CLASSIFIER__DOMAIN;
