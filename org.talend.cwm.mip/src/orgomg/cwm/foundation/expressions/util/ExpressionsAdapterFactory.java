...
public class ExpressionsAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ExpressionsSwitch<Adapter> modelSwitch =
        new ExpressionsSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseConstantNode(ConstantNode object) {
                return createConstantNodeAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link orgomg.cwm.foundation.expressions.ExpressionNode <em>Expression Node</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link orgomg.cwm.foundation.expressions.ConstantNode <em>Constant Node</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link orgomg.cwm.foundation.expressions.ElementNode <em>Element Node</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link orgomg.cwm.foundation.expressions.FeatureNode <em>Feature Node</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
