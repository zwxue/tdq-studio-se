 ...
 * $Id$
 */
package orgomg.cwm.foundation.expressions.util;
...
public class ExpressionsSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case ExpressionsPackage.EXPRESSION_NODE: {
                ...
                if (result == null) result = caseElement(expressionNode);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ExpressionsPackage.CONSTANT_NODE: {
                ConstantNode constantNode = (ConstantNode)theEObject;
                T result = caseConstantNode(constantNode);
                if (result == null) result = caseExpressionNode(constantNode);
                if (result == null) result = caseElement(constantNode);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ExpressionsPackage.ELEMENT_NODE: {
                ...
                if (result == null) result = caseExpressionNode(elementNode);
                if (result == null) result = caseElement(elementNode);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case ExpressionsPackage.FEATURE_NODE: {
                ...
                if (result == null) result = caseExpressionNode(featureNode);
                if (result == null) result = caseElement(featureNode);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Constant Node</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Constant Node</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseConstantNode(ConstantNode object) {
        return null;
    }
