 ...
 * @generated
 */
public class TypemappingSwitch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case TypemappingPackage.TYPE_MAPPING: {
                ...
                if (result == null) result = caseModelElement(typeMapping);
            ...
            case TypemappingPackage.TYPE_SYSTEM: {
                ...
                if (result == null) result = casePackage(typeSystem);
                if (result == null) result = caseNamespace(typeSystem);
                if (result == null) result = caseModelElement(typeSystem);
                if (result == null) result = caseElement(typeSystem);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
