 ...
 * $Id$
 */
package orgomg.cwm.foundation.typemapping.util;
...
public class TypemappingAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected TypemappingSwitch<Adapter> modelSwitch =
        new TypemappingSwitch<Adapter>() {
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link orgomg.cwm.foundation.typemapping.TypeMapping <em>Type Mapping</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link orgomg.cwm.foundation.typemapping.TypeSystem <em>Type System</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
