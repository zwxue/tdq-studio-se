...
public interface TransformationPackage extends EPackage {
     ...
     * @ordered
     */
    int TRANSFORMATION__DASDL_PROPERTY = CorePackage.NAMESPACE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int DATA_OBJECT_SET__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TRANSFORMATION_TASK__DASDL_PROPERTY = SoftwaredeploymentPackage.COMPONENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TRANSFORMATION_TASK__DOMAIN = SoftwaredeploymentPackage.COMPONENT__DOMAIN;
     ...
     * @ordered
     */
    int TRANSFORMATION_ACTIVITY__DASDL_PROPERTY = CorePackage.SUBSYSTEM__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TRANSFORMATION_ACTIVITY__DOMAIN = CorePackage.SUBSYSTEM__DOMAIN;
     ...
     * @ordered
     */
    int TRANSFORMATION_ACTIVITY__SIMPLE_DIMENSION = CorePackage.SUBSYSTEM__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int TRANSFORMATION_MAP__DASDL_PROPERTY = TRANSFORMATION__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TRANSFORMATION_TREE__DASDL_PROPERTY = TRANSFORMATION__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CLASSIFIER_MAP__DASDL_PROPERTY = CorePackage.NAMESPACE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int FEATURE_MAP__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CLASSIFIER_FEATURE_MAP__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
