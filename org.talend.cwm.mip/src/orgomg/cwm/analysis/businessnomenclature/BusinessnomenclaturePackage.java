...
public interface BusinessnomenclaturePackage extends EPackage {
     ...
     * @ordered
     */
    int VOCABULARY_ELEMENT__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int NOMENCLATURE__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TAXONOMY__DASDL_PROPERTY = NOMENCLATURE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int GLOSSARY__DASDL_PROPERTY = NOMENCLATURE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int BUSINESS_DOMAIN__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CONCEPT__DASDL_PROPERTY = VOCABULARY_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TERM__DASDL_PROPERTY = VOCABULARY_ELEMENT__DASDL_PROPERTY;
