 ...
 * @generated
 */
public class BusinessnomenclaturePackageImpl extends EPackageImpl implements BusinessnomenclaturePackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @see orgomg.cwm.analysis.businessnomenclature.BusinessnomenclaturePackage#eNS_URI
     * @see #init()
     * @generated
     */
    private BusinessnomenclaturePackageImpl() {
        super(eNS_URI, BusinessnomenclatureFactory.eINSTANCE);
    }
     ...
     * 
     * <p>This method is used to initialize {@link BusinessnomenclaturePackage#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static BusinessnomenclaturePackage init() {
        if (isInited) return (BusinessnomenclaturePackage)EPackage.Registry.INSTANCE.getEPackage(BusinessnomenclaturePackage.eNS_URI);

        // Obtain or create and register package
        BusinessnomenclaturePackageImpl theBusinessnomenclaturePackage = (BusinessnomenclaturePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BusinessnomenclaturePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BusinessnomenclaturePackageImpl());
        ...
        theBusinessnomenclaturePackage.freeze();

  
        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(BusinessnomenclaturePackage.eNS_URI, theBusinessnomenclaturePackage);
        return theBusinessnomenclaturePackage;
    }
     ...
     * @generated
     */
    public EAttribute getVocabularyElement_Definition() {
     ...
     * @generated
     */
    public EAttribute getVocabularyElement_Example() {
     ...
     * @generated
     */
    public EAttribute getVocabularyElement_Usage() {
        return (EAttribute)vocabularyElementEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EReference getVocabularyElement_RelatedElement() {
        return (EReference)vocabularyElementEClass.getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public EReference getVocabularyElement_Element() {
        return (EReference)vocabularyElementEClass.getEStructuralFeatures().get(4);
    }
     ...
     * @generated
     */
    public EReference getVocabularyElement_ModelElement() {
        return (EReference)vocabularyElementEClass.getEStructuralFeatures().get(5);
    }
     ...
     * @generated
     */
    public EReference getNomenclature_Parent() {
        return (EReference)nomenclatureEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EReference getNomenclature_Child() {
     ...
     * @generated
     */
    public EReference getTaxonomy_Glossary() {
     ...
     * @generated
     */
    public EAttribute getGlossary_Language() {
     ...
     * @generated
     */
    public EReference getGlossary_Taxonomy() {
     ...
     * @generated
     */
    public EReference getConcept_Term() {
     ...
     * @generated
     */
    public EReference getConcept_RelatedConcept() {
     ...
     * @generated
     */
    public EReference getTerm_RelatedTerm() {
     ...
     * @generated
     */
    public EReference getTerm_PreferredTerm() {
     ...
     * @generated
     */
    public EReference getTerm_WiderTerm() {
     ...
     * @generated
     */
    public EReference getTerm_NarrowerTerm() {
     ...
     * @generated
     */
    public BusinessnomenclatureFactory getBusinessnomenclatureFactory() {
        return (BusinessnomenclatureFactory)getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        createEAttribute(vocabularyElementEClass, VOCABULARY_ELEMENT__DEFINITION);
        createEAttribute(vocabularyElementEClass, VOCABULARY_ELEMENT__EXAMPLE);
        createEAttribute(vocabularyElementEClass, VOCABULARY_ELEMENT__USAGE);
        createEReference(vocabularyElementEClass, VOCABULARY_ELEMENT__RELATED_ELEMENT);
        createEReference(vocabularyElementEClass, VOCABULARY_ELEMENT__ELEMENT);
        createEReference(vocabularyElementEClass, VOCABULARY_ELEMENT__MODEL_ELEMENT);

        nomenclatureEClass = createEClass(NOMENCLATURE);
        createEReference(nomenclatureEClass, NOMENCLATURE__PARENT);
        createEReference(nomenclatureEClass, NOMENCLATURE__CHILD);

        taxonomyEClass = createEClass(TAXONOMY);
        createEReference(taxonomyEClass, TAXONOMY__GLOSSARY);

        glossaryEClass = createEClass(GLOSSARY);
        createEAttribute(glossaryEClass, GLOSSARY__LANGUAGE);
        createEReference(glossaryEClass, GLOSSARY__TAXONOMY);

        businessDomainEClass = createEClass(BUSINESS_DOMAIN);

        conceptEClass = createEClass(CONCEPT);
        createEReference(conceptEClass, CONCEPT__TERM);
        createEReference(conceptEClass, CONCEPT__RELATED_CONCEPT);
        createEReference(conceptEClass, CONCEPT__CONCEPT);

        termEClass = createEClass(TERM);
        createEReference(termEClass, TERM__CONCEPT);
        createEReference(termEClass, TERM__RELATED_TERM);
        createEReference(termEClass, TERM__TERM);
        createEReference(termEClass, TERM__PREFERRED_TERM);
        createEReference(termEClass, TERM__SYNONYM);
        createEReference(termEClass, TERM__WIDER_TERM);
        createEReference(termEClass, TERM__NARROWER_TERM);
    }
    ...
    public void initializePackageContents() {
        ...
        vocabularyElementEClass.getESuperTypes().add(theCorePackage.getModelElement());
        nomenclatureEClass.getESuperTypes().add(theCorePackage.getPackage());
        taxonomyEClass.getESuperTypes().add(this.getNomenclature());
        glossaryEClass.getESuperTypes().add(this.getNomenclature());
        businessDomainEClass.getESuperTypes().add(theCorePackage.getPackage());
        conceptEClass.getESuperTypes().add(this.getVocabularyElement());
        ...
        initEAttribute(getVocabularyElement_Definition(), theCorePackage.getString(), "definition", null, 0, 1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getVocabularyElement_Example(), theCorePackage.getString(), "example", null, 0, 1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getVocabularyElement_Usage(), theCorePackage.getString(), "usage", null, 0, 1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getVocabularyElement_RelatedElement(), this.getVocabularyElement(), this.getVocabularyElement_Element(), "relatedElement", null, 0, -1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getVocabularyElement_Element(), this.getVocabularyElement(), this.getVocabularyElement_RelatedElement(), "element", null, 0, -1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getVocabularyElement_ModelElement(), theCorePackage.getModelElement(), theCorePackage.getModelElement_VocabularyElement(), "modelElement", null, 0, -1, VocabularyElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(nomenclatureEClass, Nomenclature.class, "Nomenclature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getNomenclature_Parent(), this.getNomenclature(), this.getNomenclature_Child(), "parent", null, 0, 1, Nomenclature.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getNomenclature_Child(), this.getNomenclature(), this.getNomenclature_Parent(), "child", null, 0, -1, Nomenclature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(taxonomyEClass, Taxonomy.class, "Taxonomy", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTaxonomy_Glossary(), this.getGlossary(), this.getGlossary_Taxonomy(), "glossary", null, 0, -1, Taxonomy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(glossaryEClass, Glossary.class, "Glossary", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getGlossary_Language(), theCorePackage.getString(), "language", null, 0, 1, Glossary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getGlossary_Taxonomy(), this.getTaxonomy(), this.getTaxonomy_Glossary(), "taxonomy", null, 0, -1, Glossary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getConcept_Term(), this.getTerm(), this.getTerm_Concept(), "term", null, 0, -1, Concept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConcept_RelatedConcept(), this.getConcept(), this.getConcept_Concept(), "relatedConcept", null, 0, -1, Concept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConcept_Concept(), this.getConcept(), this.getConcept_RelatedConcept(), "concept", null, 0, -1, Concept.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(termEClass, Term.class, "Term", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTerm_Concept(), this.getConcept(), this.getConcept_Term(), "concept", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTerm_RelatedTerm(), this.getTerm(), this.getTerm_Term(), "relatedTerm", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTerm_Term(), this.getTerm(), this.getTerm_RelatedTerm(), "term", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTerm_PreferredTerm(), this.getTerm(), this.getTerm_Synonym(), "preferredTerm", null, 0, 1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTerm_Synonym(), this.getTerm(), this.getTerm_PreferredTerm(), "synonym", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTerm_WiderTerm(), this.getTerm(), this.getTerm_NarrowerTerm(), "widerTerm", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTerm_NarrowerTerm(), this.getTerm(), this.getTerm_WiderTerm(), "narrowerTerm", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        // Create resource
        createResource(eNS_URI);
    }

} //BusinessnomenclaturePackageImpl
