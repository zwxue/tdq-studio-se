...
public interface InformationvisualizationPackage extends EPackage {
     ...
     * @ordered
     */
    int RENDERED_OBJECT__DASDL_PROPERTY = CorePackage.CLASSIFIER__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int RENDERED_OBJECT__DOMAIN = CorePackage.CLASSIFIER__DOMAIN;
     ...
     * @ordered
     */
    int RENDERED_OBJECT__SIMPLE_DIMENSION = CorePackage.CLASSIFIER__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int RENDERED_OBJECT_SET__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
