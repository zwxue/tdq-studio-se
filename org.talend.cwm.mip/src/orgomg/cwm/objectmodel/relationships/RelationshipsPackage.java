...
public interface RelationshipsPackage extends EPackage {
     ...
     * @ordered
     */
    int ASSOCIATION__DASDL_PROPERTY = CorePackage.CLASS__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int ASSOCIATION__DOMAIN = CorePackage.CLASS__DOMAIN;
     ...
     * @ordered
     */
    int ASSOCIATION__SIMPLE_DIMENSION = CorePackage.CLASS__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int ASSOCIATION_END__DASDL_PROPERTY = CorePackage.STRUCTURAL_FEATURE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int ASSOCIATION_END__DATA_ITEM = CorePackage.STRUCTURAL_FEATURE__DATA_ITEM;
     ...
     * @ordered
     */
    int ASSOCIATION_END__REMAP = CorePackage.STRUCTURAL_FEATURE__REMAP;
     ...
     * @ordered
     */
    int GENERALIZATION__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
