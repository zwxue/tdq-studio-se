...
public abstract class ModelElementImpl extends ElementImpl implements ModelElement {
    ...
    public EList<DASDLProperty> getDasdlProperty() {
        if (dasdlProperty == null) {
            dasdlProperty = new EObjectWithInverseResolvingEList<DASDLProperty>(DASDLProperty.class, this, CorePackage.MODEL_ELEMENT__DASDL_PROPERTY, DmsiiPackage.DASDL_PROPERTY__OWNER);
        }
