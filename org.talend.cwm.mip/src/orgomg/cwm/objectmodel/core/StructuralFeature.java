 ...
 *   <li>{@link orgomg.cwm.objectmodel.core.StructuralFeature#getDataItem <em>Data Item</em>}</li>
 *   <li>{@link orgomg.cwm.objectmodel.core.StructuralFeature#getRemap <em>Remap</em>}</li>
 * </ul>
 * </p>
 *
...
public interface StructuralFeature extends Feature {
     ...
     * It is bidirectional and its opposite is '{@link orgomg.cwmx.resource.dmsii.DataItem#getStructure <em>Structure</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see orgomg.cwm.objectmodel.core.CorePackage#getStructuralFeature_DataItem()
     * @see orgomg.cwmx.resource.dmsii.DataItem#getStructure
     * @model opposite="structure"
     * @generated
     */
    EList<DataItem> getDataItem();

    /**
     * Returns the value of the '<em><b>Remap</b></em>' reference list.
     * The list contents are of type {@link orgomg.cwmx.resource.dmsii.Remap}.
     * It is bidirectional and its opposite is '{@link orgomg.cwmx.resource.dmsii.Remap#getStructure <em>Structure</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Identifies the Remap instances that remap this structure.
     * <!-- end-model-doc -->
     * @return the value of the '<em>Remap</em>' reference list.
     * @see orgomg.cwm.objectmodel.core.CorePackage#getStructuralFeature_Remap()
     * @see orgomg.cwmx.resource.dmsii.Remap#getStructure
     * @model opposite="structure"
     * @generated
     */
    EList<Remap> getRemap();
