 ...
 * $Id$
 */
package orgomg.cwm.objectmodel.core.util;
...
public class CoreSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case CorePackage.CLASS: {
                orgomg.cwm.objectmodel.core.Class class_ = (orgomg.cwm.objectmodel.core.Class)theEObject;
            ...
            case CorePackage.PACKAGE: {
                orgomg.cwm.objectmodel.core.Package package_ = (orgomg.cwm.objectmodel.core.Package)theEObject;
            ...
            case CorePackage.SUBSYSTEM: {
                ...
                if (result == null) result = caseClassifier(subsystem);
                if (result == null) result = casePackage(subsystem);
                if (result == null) result = caseNamespace(subsystem);
            ...
            case CorePackage.STRUCTURAL_FEATURE: {
            ...
            case CorePackage.PROCEDURE_EXPRESSION: {
                ProcedureExpression procedureExpression = (ProcedureExpression)theEObject;
                T result = caseProcedureExpression(procedureExpression);
                if (result == null) result = caseExpression(procedureExpression);
                if (result == null) result = caseElement(procedureExpression);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Procedure Expression</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Procedure Expression</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseProcedureExpression(ProcedureExpression object) {
        return null;
    }
