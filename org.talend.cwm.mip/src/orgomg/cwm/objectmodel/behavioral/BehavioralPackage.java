...
public interface BehavioralPackage extends EPackage {
     ...
     * @ordered
     */
    int ARGUMENT__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int BEHAVIORAL_FEATURE__DASDL_PROPERTY = CorePackage.FEATURE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CALL_ACTION__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int EVENT__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int INTERFACE__DASDL_PROPERTY = CorePackage.CLASSIFIER__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int INTERFACE__DOMAIN = CorePackage.CLASSIFIER__DOMAIN;
     ...
     * @ordered
     */
    int INTERFACE__SIMPLE_DIMENSION = CorePackage.CLASSIFIER__SIMPLE_DIMENSION;
     ...
     * @ordered
     */
    int METHOD__DASDL_PROPERTY = BEHAVIORAL_FEATURE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int OPERATION__DASDL_PROPERTY = BEHAVIORAL_FEATURE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int PARAMETER__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
