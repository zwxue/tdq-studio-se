...
public interface WarehouseprocessPackage extends EPackage {
     ...
     * @ordered
     */
    int WAREHOUSE_PROCESS__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int WAREHOUSE_STEP__DASDL_PROPERTY = WAREHOUSE_PROCESS__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int PROCESS_PACKAGE__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int WAREHOUSE_ACTIVITY__DASDL_PROPERTY = WAREHOUSE_PROCESS__DASDL_PROPERTY;
