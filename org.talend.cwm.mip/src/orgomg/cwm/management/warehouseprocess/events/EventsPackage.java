...
public interface EventsPackage extends EPackage {
     ...
     * @ordered
     */
    int WAREHOUSE_EVENT__DASDL_PROPERTY = BehavioralPackage.EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int SCHEDULE_EVENT__DASDL_PROPERTY = WAREHOUSE_EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int POINT_IN_TIME_EVENT__DASDL_PROPERTY = SCHEDULE_EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CUSTOM_CALENDAR_EVENT__DASDL_PROPERTY = POINT_IN_TIME_EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CUSTOM_CALENDAR__DASDL_PROPERTY = CorePackage.PACKAGE__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CALENDAR_DATE__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int INTERVAL_EVENT__DASDL_PROPERTY = SCHEDULE_EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int EXTERNAL_EVENT__DASDL_PROPERTY = WAREHOUSE_EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int INTERNAL_EVENT__DASDL_PROPERTY = WAREHOUSE_EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CASCADE_EVENT__DASDL_PROPERTY = INTERNAL_EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int RETRY_EVENT__DASDL_PROPERTY = INTERNAL_EVENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int RECURRING_POINT_IN_TIME_EVENT__DASDL_PROPERTY = POINT_IN_TIME_EVENT__DASDL_PROPERTY;
