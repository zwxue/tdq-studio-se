...
public interface WarehouseoperationPackage extends EPackage {
     ...
     * @ordered
     */
    int MEASUREMENT__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int CHANGE_REQUEST__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int TRANSFORMATION_EXECUTION__DASDL_PROPERTY = CorePackage.MODEL_ELEMENT__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int ACTIVITY_EXECUTION__DASDL_PROPERTY = TRANSFORMATION_EXECUTION__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int STEP_EXECUTION__DASDL_PROPERTY = TRANSFORMATION_EXECUTION__DASDL_PROPERTY;
