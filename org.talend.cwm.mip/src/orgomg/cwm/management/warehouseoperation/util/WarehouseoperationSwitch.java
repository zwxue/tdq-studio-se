 ...
 * @generated
 */
public class WarehouseoperationSwitch<T> {
    /**
     ...
     * @generated
     */
    public WarehouseoperationSwitch() {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case WarehouseoperationPackage.MEASUREMENT: {
                ...
                if (result == null) result = caseModelElement(measurement);
            ...
            case WarehouseoperationPackage.CHANGE_REQUEST: {
                ...
                if (result == null) result = caseElement(changeRequest);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case WarehouseoperationPackage.TRANSFORMATION_EXECUTION: {
                ...
                if (result == null) result = caseModelElement(transformationExecution);
                if (result == null) result = caseElement(transformationExecution);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case WarehouseoperationPackage.ACTIVITY_EXECUTION: {
                ...
                if (result == null) result = caseTransformationExecution(activityExecution);
                if (result == null) result = caseModelElement(activityExecution);
                if (result == null) result = caseElement(activityExecution);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case WarehouseoperationPackage.STEP_EXECUTION: {
                ...
                if (result == null) result = caseTransformationExecution(stepExecution);
                if (result == null) result = caseModelElement(stepExecution);
                if (result == null) result = caseElement(stepExecution);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
