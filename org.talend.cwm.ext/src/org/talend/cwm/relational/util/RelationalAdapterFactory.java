...
public class RelationalAdapterFactory extends AdapterFactoryImpl {
    ...
    protected RelationalSwitch<Adapter> modelSwitch =
        new RelationalSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseTdCatalog(TdCatalog object) {
                return createTdCatalogAdapter();
            }
            @Override
            public Adapter caseTdSchema(TdSchema object) {
                return createTdSchemaAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.cwm.relational.TdCatalog <em>Td Catalog</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.cwm.relational.TdSchema <em>Td Schema</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
