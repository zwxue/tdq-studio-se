...
public class TdSqlDataTypeImpl extends SQLSimpleTypeImpl implements TdSqlDataType {
     ...
     * @ordered
     */
    protected static final short NULLABLE_EDEFAULT = 0;
     ...
     * @ordered
     */
    protected short nullable = NULLABLE_EDEFAULT;
    ...
    public void setJavaDataType(int newJavaDataType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__JAVA_DATA_TYPE, oldJavaDataType, javaDataType));
    }
    ...
    public void setNullable(short newNullable) {
        short oldNullable = nullable;
        nullable = newNullable;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__NULLABLE, oldNullable, nullable));
    }
    ...
    public void setUnsignedAttribute(boolean newUnsignedAttribute) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__UNSIGNED_ATTRIBUTE, oldUnsignedAttribute, unsignedAttribute));
    }
    ...
    public void setCaseSensitive(boolean newCaseSensitive) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__CASE_SENSITIVE, oldCaseSensitive, caseSensitive));
    }
    ...
    public void setAutoIncrement(boolean newAutoIncrement) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__AUTO_INCREMENT, oldAutoIncrement, autoIncrement));
    }
    ...
    public void setLocalTypeName(String newLocalTypeName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__LOCAL_TYPE_NAME, oldLocalTypeName, localTypeName));
    }
    ...
    public void setSearchable(short newSearchable) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, RelationalPackage.TD_SQL_DATA_TYPE__SEARCHABLE, oldSearchable, searchable));
    }
