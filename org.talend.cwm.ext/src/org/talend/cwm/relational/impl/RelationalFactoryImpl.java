...
public class RelationalFactoryImpl extends EFactoryImpl implements RelationalFactory {
    ...
    public static RelationalFactory init() {
        try {
            RelationalFactory theRelationalFactory = (RelationalFactory)EPackage.Registry.INSTANCE.getEFactory("http:///org/talend/cwm/resource.relational"); 
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case RelationalPackage.TD_TABLE: return createTdTable();
            case RelationalPackage.TD_VIEW: return createTdView();
            case RelationalPackage.TD_CATALOG: return createTdCatalog();
     ...
     * @generated
     */
    public TdCatalog createTdCatalog() {
        TdCatalogImpl tdCatalog = new TdCatalogImpl();
        return tdCatalog;
    }
     ...
     * @generated
     */
    public TdSchema createTdSchema() {
        TdSchemaImpl tdSchema = new TdSchemaImpl();
        return tdSchema;
    }
