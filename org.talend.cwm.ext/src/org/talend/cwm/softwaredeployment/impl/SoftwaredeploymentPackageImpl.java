...
public class SoftwaredeploymentPackageImpl extends EPackageImpl implements SoftwaredeploymentPackage {
     ...
     * @generated
     */
    private EClass tdProviderConnectionEClass = null;
     ...
     * @generated
     */
    private EClass tdDataProviderEClass = null;
     ...
     * @generated
     */
    public EClass getTdProviderConnection() {
        return tdProviderConnectionEClass;
    }
     ...
     * @generated
     */
    public EAttribute getTdProviderConnection_Login() {
        return (EAttribute)tdProviderConnectionEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EAttribute getTdProviderConnection_Password() {
        return (EAttribute)tdProviderConnectionEClass.getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public EAttribute getTdProviderConnection_ConnectionString() {
        return (EAttribute)tdProviderConnectionEClass.getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EAttribute getTdProviderConnection_DriverClassName() {
        return (EAttribute)tdProviderConnectionEClass.getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public EClass getTdDataProvider() {
        return tdDataProviderEClass;
    }
    ...
    public void createPackageContents() {
        ...
        tdProviderConnectionEClass = createEClass(TD_PROVIDER_CONNECTION);
        createEAttribute(tdProviderConnectionEClass, TD_PROVIDER_CONNECTION__LOGIN);
        createEAttribute(tdProviderConnectionEClass, TD_PROVIDER_CONNECTION__PASSWORD);
        createEAttribute(tdProviderConnectionEClass, TD_PROVIDER_CONNECTION__CONNECTION_STRING);
        createEAttribute(tdProviderConnectionEClass, TD_PROVIDER_CONNECTION__DRIVER_CLASS_NAME);

        tdDataManagerEClass = createEClass(TD_DATA_MANAGER);

        tdDataProviderEClass = createEClass(TD_DATA_PROVIDER);
    ...
    public void initializePackageContents() {
        ...
        orgomg.cwm.foundation.softwaredeployment.SoftwaredeploymentPackage theSoftwaredeploymentPackage_1 = (orgomg.cwm.foundation.softwaredeployment.SoftwaredeploymentPackage)EPackage.Registry.INSTANCE.getEPackage(orgomg.cwm.foundation.softwaredeployment.SoftwaredeploymentPackage.eNS_URI);
        ...
        tdProviderConnectionEClass.getESuperTypes().add(theSoftwaredeploymentPackage_1.getProviderConnection());
        tdDataManagerEClass.getESuperTypes().add(theSoftwaredeploymentPackage_1.getDataManager());
        tdDataProviderEClass.getESuperTypes().add(theSoftwaredeploymentPackage_1.getDataProvider());
        ...
        initEClass(tdProviderConnectionEClass, TdProviderConnection.class, "TdProviderConnection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getTdProviderConnection_Login(), ecorePackage.getEString(), "login", null, 0, 1, TdProviderConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTdProviderConnection_Password(), ecorePackage.getEString(), "password", null, 0, 1, TdProviderConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTdProviderConnection_ConnectionString(), ecorePackage.getEString(), "connectionString", null, 0, 1, TdProviderConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getTdProviderConnection_DriverClassName(), ecorePackage.getEString(), "driverClassName", null, 0, 1, TdProviderConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(tdDataManagerEClass, TdDataManager.class, "TdDataManager", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(tdDataProviderEClass, TdDataProvider.class, "TdDataProvider", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(tdSoftwareSystemEClass, TdSoftwareSystem.class, "TdSoftwareSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
