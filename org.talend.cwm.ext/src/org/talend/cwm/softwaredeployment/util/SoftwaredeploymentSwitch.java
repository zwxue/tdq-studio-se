...
public class SoftwaredeploymentSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case SoftwaredeploymentPackage.TD_PROVIDER_CONNECTION: {
                TdProviderConnection tdProviderConnection = (TdProviderConnection)theEObject;
                T result = caseTdProviderConnection(tdProviderConnection);
                if (result == null) result = caseProviderConnection(tdProviderConnection);
                if (result == null) result = caseModelElement(tdProviderConnection);
                if (result == null) result = caseElement(tdProviderConnection);
            ...
            case SoftwaredeploymentPackage.TD_DATA_MANAGER: {
                ...
                if (result == null) result = caseDataManager(tdDataManager);
                if (result == null) result = caseDeployedComponent(tdDataManager);
                if (result == null) result = casePackage(tdDataManager);
                if (result == null) result = caseNamespace(tdDataManager);
                if (result == null) result = caseModelElement(tdDataManager);
                if (result == null) result = caseElement(tdDataManager);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case SoftwaredeploymentPackage.TD_DATA_PROVIDER: {
                TdDataProvider tdDataProvider = (TdDataProvider)theEObject;
                T result = caseTdDataProvider(tdDataProvider);
                if (result == null) result = caseDataProvider(tdDataProvider);
                if (result == null) result = caseDataManager(tdDataProvider);
                if (result == null) result = caseDeployedComponent(tdDataProvider);
                if (result == null) result = casePackage(tdDataProvider);
                if (result == null) result = caseNamespace(tdDataProvider);
                if (result == null) result = caseModelElement(tdDataProvider);
                if (result == null) result = caseElement(tdDataProvider);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case SoftwaredeploymentPackage.TD_SOFTWARE_SYSTEM: {
                ...
                if (result == null) result = caseSoftwareSystem(tdSoftwareSystem);
                if (result == null) result = caseSubsystem(tdSoftwareSystem);
                if (result == null) result = caseClassifier(tdSoftwareSystem);
                if (result == null) result = casePackage(tdSoftwareSystem);
                if (result == null) result = caseNamespace(tdSoftwareSystem);
                if (result == null) result = caseModelElement(tdSoftwareSystem);
                if (result == null) result = caseElement(tdSoftwareSystem);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case SoftwaredeploymentPackage.TD_MACHINE: {
                ...
                if (result == null) result = caseMachine(tdMachine);
                if (result == null) result = caseNamespace(tdMachine);
                if (result == null) result = caseModelElement(tdMachine);
                if (result == null) result = caseElement(tdMachine);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Td Provider Connection</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Td Provider Connection</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseTdProviderConnection(TdProviderConnection object) {
        return null;
    }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Td Data Provider</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Td Data Provider</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseTdDataProvider(TdDataProvider object) {
        return null;
    }
