...
public class SoftwaredeploymentAdapterFactory extends AdapterFactoryImpl {
    ...
    protected SoftwaredeploymentSwitch<Adapter> modelSwitch =
        new SoftwaredeploymentSwitch<Adapter>() {
            @Override
            public Adapter caseTdProviderConnection(TdProviderConnection object) {
                return createTdProviderConnectionAdapter();
            }
            @Override
            ...
            @Override
            public Adapter caseTdDataProvider(TdDataProvider object) {
                return createTdDataProviderAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.cwm.softwaredeployment.TdProviderConnection <em>Td Provider Connection</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.cwm.softwaredeployment.TdDataProvider <em>Td Data Provider</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
