...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Td XML Element</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class TdXMLElementImpl extends ElementImpl implements TdXMLElement {
        ...
        if (xsdElementDeclaration != null && xsdElementDeclaration.eIsProxy()) {
            ...
            if (xsdElementDeclaration != oldXsdElementDeclaration) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, XmlPackage.TD_XML_ELEMENT__XSD_ELEMENT_DECLARATION, oldXsdElementDeclaration, xsdElementDeclaration));
            }
        }
    ...
    public void setXsdElementDeclaration(EObject newXsdElementDeclaration) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XmlPackage.TD_XML_ELEMENT__XSD_ELEMENT_DECLARATION, oldXsdElementDeclaration, xsdElementDeclaration));
    }
    ...
    public TdXMLDocument getOwnedDocument() {
        if (ownedDocument != null && ownedDocument.eIsProxy()) {
            ...
            if (ownedDocument != oldOwnedDocument) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, XmlPackage.TD_XML_ELEMENT__OWNED_DOCUMENT, oldOwnedDocument, ownedDocument));
            }
        }
    ...
    public void setOwnedDocument(TdXMLDocument newOwnedDocument) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XmlPackage.TD_XML_ELEMENT__OWNED_DOCUMENT, oldOwnedDocument, ownedDocument));
    }
    ...
    public NotificationChain basicSetXmlContent(TdXMLContent newXmlContent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlPackage.TD_XML_ELEMENT__XML_CONTENT, oldXmlContent, newXmlContent);
    ...
    public void setXmlContent(TdXMLContent newXmlContent) {
        if (newXmlContent != xmlContent) {
            ...
            if (xmlContent != null)
                msgs = ((InternalEObject)xmlContent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmlPackage.TD_XML_ELEMENT__XML_CONTENT, null, msgs);
            if (newXmlContent != null)
                msgs = ((InternalEObject)newXmlContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmlPackage.TD_XML_ELEMENT__XML_CONTENT, null, msgs);
            msgs = basicSetXmlContent(newXmlContent, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XmlPackage.TD_XML_ELEMENT__XML_CONTENT, newXmlContent, newXmlContent));
    }
