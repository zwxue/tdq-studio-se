...
/**
 * This class shows how you can customize Zql so it supports custom functions In this example, the following functions
 * are defined : - whynot (1 parameter) - nvl (2 parameters) - concat (any number of parameters) For example, the
 * following request will be accepted: select nvl(a, 0), concat(b, 'abc', d, 123), whynot(c) from mytable;
 */
