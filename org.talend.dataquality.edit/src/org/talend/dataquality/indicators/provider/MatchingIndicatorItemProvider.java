...
/**
 * This is the item provider adapter for a {@link org.talend.dataquality.indicators.MatchingIndicator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MatchingIndicatorItemProvider
     ...
     * @generated
     */
    public MatchingIndicatorItemProvider(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        String label = ((MatchingIndicator)object).getName();
        return label == null || label.length() == 0 ?
            getString("_UI_MatchingIndicator_type") :
            getString("_UI_MatchingIndicator_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(MatchingIndicator.class)) {
