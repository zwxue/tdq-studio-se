        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_TableIndicator_rowCount_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_TableIndicator_rowCount_feature", "_UI_TableIndicator_type"),
                 SchemaPackage.Literals.TABLE_INDICATOR__ROW_COUNT,
                 true,
                 false,
                 false,
