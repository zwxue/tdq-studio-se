...
/**
 * This is the item provider adapter for a {@link org.talend.dataquality.domain.pattern.Pattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(PatternPackage.Literals.PATTERN__COMPONENTS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (PatternPackage.Literals.PATTERN__COMPONENTS,
                 PatternFactory.eINSTANCE.createPatternComponent()));
        ...
        newChildDescriptors.add
            (createChildParameter
                (PatternPackage.Literals.PATTERN__COMPONENTS,
                 PatternFactory.eINSTANCE.createAttributeReference()));

        newChildDescriptors.add
            (createChildParameter
                (PatternPackage.Literals.PATTERN__COMPONENTS,
                 PatternFactory.eINSTANCE.createComponentReference()));
    }
