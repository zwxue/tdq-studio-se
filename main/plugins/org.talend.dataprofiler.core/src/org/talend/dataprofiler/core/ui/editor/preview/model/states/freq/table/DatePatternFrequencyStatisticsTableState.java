 ...
 * 
 */
public class DatePatternFrequencyStatisticsTableState extends FrequencyStatisticsTableState {

    public DatePatternFrequencyStatisticsTableState(List<IndicatorUnit> units) {
        super(units);
    }
