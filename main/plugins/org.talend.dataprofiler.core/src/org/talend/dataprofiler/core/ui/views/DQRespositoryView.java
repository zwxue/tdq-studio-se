            ...
            public void mouseDoubleClick(MouseEvent e) {
                ...
                if (item != null) {
                    ...
                    if (obj instanceof DQRepositoryNode) {
                        ...
                        } else if (obj instanceof HadoopClusterConnectionRepNode) { // MOD gdbu 2011-4-1 bug 20051
                            new EditHadoopClusterAction((IRepositoryNode) obj).run();
                        } else if (obj instanceof HDFSOfHCConnectionNode) { // MOD gdbu 2011-4-1 bug 20051
