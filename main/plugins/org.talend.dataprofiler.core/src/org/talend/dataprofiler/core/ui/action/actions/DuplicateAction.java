        ...
        try {
            ...
            for (final IRepositoryNode node : nodeArray) {
                if (node != null) {
                    ...
                    if ((modelElement == null || modelElement.eResource() == null || modelElement.getName() == null || node
                            .getParent() instanceof UserDefIndicatorFolderRepNode
                            && UDIHelper.getUDICategory(modelElement) == null) && !(item instanceof TDQFileItem)) {
