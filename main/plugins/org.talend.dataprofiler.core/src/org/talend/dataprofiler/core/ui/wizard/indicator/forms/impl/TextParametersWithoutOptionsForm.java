 ...
 */
public class TextParametersWithoutOptionsForm extends AbstractIndicatorForm {

    private Text numberTxt;

    public TextParametersWithoutOptionsForm(Composite parent, int style, IndicatorParameters parameters) {
    ...
    protected void addFields() {
        ...
        lab.setText(DefaultMessagesImpl.getString("FreqTextParametersForm.numberOfResultsShown")); //$NON-NLS-1$
    ...
    public FormEnum getFormEnum() {
        return FormEnum.TextParametersWithoutOptionsForm;
    }
