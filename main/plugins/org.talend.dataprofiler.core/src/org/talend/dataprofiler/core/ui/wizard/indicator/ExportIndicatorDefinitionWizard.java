...
public class ExportIndicatorDefinitionWizard extends Wizard {
    ...
    private static Logger log = Logger.getLogger(ExportIndicatorDefinitionWizard.class);

    private ExportIndicatorDefinitionWizardPage page;
    ...
    public void addPages() {
        page = new ExportIndicatorDefinitionWizardPage();
        addPage(page);
    }
}
