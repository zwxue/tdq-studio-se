 ...
 * 
 */
public class DateLowFrequencyStatisticsTableState extends LowFrequencyStatisticsTableState {

    public DateLowFrequencyStatisticsTableState(List<IndicatorUnit> units) {
        super(units);
    }
