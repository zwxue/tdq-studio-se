...
import org.talend.dataprofiler.core.ui.action.actions.predefined.CreateDateAnalysisAction;
 ...
 */
public class CreateDateAnalysis extends AbstractPredefinedActionProvider {

    private ModelElement modelElement;

    @Override
    protected AbstractPredefinedAnalysisAction getAction() {
        return modelElement == null ? null : new CreateDateAnalysisAction();
    }
