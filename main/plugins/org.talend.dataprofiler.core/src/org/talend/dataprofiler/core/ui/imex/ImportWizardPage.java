    ...
    private void checkforErrors() {
        ...
        for (ItemRecord record : elements) {
            for (File depFile : record.getDependencyMap().keySet()) {
                ...
                String dptLabel = element != null && !isJrxmlDepFile ? PropertyHelper.getProperty(element).getLabel() : depFile
                        .getName();
                // TDQ-5909~
    ...
    public ItemRecord[] getElements() {
        ...
        for (Object obj : checkedElements) {
            if (obj instanceof ItemRecord) {
                ...
                // MOD qiongli 2012-6-12,add related sub-report jrxml/jasper file to elements.
