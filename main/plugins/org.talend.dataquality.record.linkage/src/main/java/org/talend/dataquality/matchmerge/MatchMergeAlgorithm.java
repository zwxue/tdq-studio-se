...
public interface MatchMergeAlgorithm {
     ...
     * method behaves same as {@link #execute(java.util.Iterator, org.talend.dataquality.matchmerge.MatchMergeAlgorithm.Callback)}
     * but without any callback.
     *
     * @param sourceRecords An iterator that provides the input for the match & merge algorithm. {@link org.talend.dataquality.matchmerge.Record record}
     *                      instances can be created from any source as long as you can provide key/value pairs.
    ...
    interface Callback {
         ...
         * @param matchResult A {@link org.talend.dataquality.matchmerge.mfb.MatchResult result} that provides additional
         *                    information on how the 2 records matched.
         */
        void onMatch(Record record1, Record record2, MatchResult matchResult);

        /**
         * Called when a new merge is created (usually called after a {@link #onMatch(Record, Record, org.talend.dataquality.matchmerge.mfb.MatchResult)}.
         ...
         * @param record2     The other record that matched.
         * @param matchResult A {@link org.talend.dataquality.matchmerge.mfb.MatchResult result} that provides additional
         *                    information on why the 2 records did not match.
         */
        ...
        /**
         * Called when merge algorithm starts.
         */
        void onBeginPostMergeProcess();

        /**
         * Called when merge algorithm stops.
         */
