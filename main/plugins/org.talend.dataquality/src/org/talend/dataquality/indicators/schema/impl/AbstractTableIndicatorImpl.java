 ...
 * <li>{@link org.talend.dataquality.indicators.schema.impl.AbstractTableIndicatorImpl#getTableName <em>Table Name</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public class AbstractTableIndicatorImpl extends IndicatorImpl implements AbstractTableIndicator {
    ...
    /**
     * The default value of the '{@link #getRowCount() <em>Row Count</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getRowCount()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getRowCount() <em>Row Count</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getRowCount()
     * @generated
    ...
    /**
     * The default value of the '{@link #getTableName() <em>Table Name</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getTableName()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getTableName() <em>Table Name</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getTableName()
     * @generated
    ...
    public void setRowCount(long newRowCount) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ABSTRACT_TABLE_INDICATOR__ROW_COUNT, oldRowCount,
                    rowCount));
        }
    }
    ...
    public void setTableName(String newTableName) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.ABSTRACT_TABLE_INDICATOR__TABLE_NAME,
