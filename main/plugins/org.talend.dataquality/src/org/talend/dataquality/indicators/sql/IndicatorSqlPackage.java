...
public interface IndicatorSqlPackage extends EPackage {
    ...
    /**
     * The meta object id for the '{@link org.talend.dataquality.indicators.sql.impl.WhereRuleAideIndicatorImpl <em>Where Rule Aide Indicator</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.talend.dataquality.indicators.sql.impl.WhereRuleAideIndicatorImpl
     * @see org.talend.dataquality.indicators.sql.impl.IndicatorSqlPackageImpl#getWhereRuleAideIndicator()
     * @generated
     */
    int WHERE_RULE_AIDE_INDICATOR = 3;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__NAME = WHERE_RULE_INDICATOR__NAME;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__VISIBILITY = WHERE_RULE_INDICATOR__VISIBILITY;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__CLIENT_DEPENDENCY = WHERE_RULE_INDICATOR__CLIENT_DEPENDENCY;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__SUPPLIER_DEPENDENCY = WHERE_RULE_INDICATOR__SUPPLIER_DEPENDENCY;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__CONSTRAINT = WHERE_RULE_INDICATOR__CONSTRAINT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__NAMESPACE = WHERE_RULE_INDICATOR__NAMESPACE;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__IMPORTER = WHERE_RULE_INDICATOR__IMPORTER;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__STEREOTYPE = WHERE_RULE_INDICATOR__STEREOTYPE;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__TAGGED_VALUE = WHERE_RULE_INDICATOR__TAGGED_VALUE;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__DOCUMENT = WHERE_RULE_INDICATOR__DOCUMENT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__DESCRIPTION = WHERE_RULE_INDICATOR__DESCRIPTION;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__RESPONSIBLE_PARTY = WHERE_RULE_INDICATOR__RESPONSIBLE_PARTY;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__ELEMENT_NODE = WHERE_RULE_INDICATOR__ELEMENT_NODE;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__SET = WHERE_RULE_INDICATOR__SET;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__RENDERED_OBJECT = WHERE_RULE_INDICATOR__RENDERED_OBJECT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__VOCABULARY_ELEMENT = WHERE_RULE_INDICATOR__VOCABULARY_ELEMENT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__MEASUREMENT = WHERE_RULE_INDICATOR__MEASUREMENT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__CHANGE_REQUEST = WHERE_RULE_INDICATOR__CHANGE_REQUEST;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__DASDL_PROPERTY = WHERE_RULE_INDICATOR__DASDL_PROPERTY;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__COUNT = WHERE_RULE_INDICATOR__COUNT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__NULL_COUNT = WHERE_RULE_INDICATOR__NULL_COUNT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__PARAMETERS = WHERE_RULE_INDICATOR__PARAMETERS;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__ANALYZED_ELEMENT = WHERE_RULE_INDICATOR__ANALYZED_ELEMENT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__DATAMINING_TYPE = WHERE_RULE_INDICATOR__DATAMINING_TYPE;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__INDICATOR_DEFINITION = WHERE_RULE_INDICATOR__INDICATOR_DEFINITION;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__INSTANTIATED_EXPRESSIONS = WHERE_RULE_INDICATOR__INSTANTIATED_EXPRESSIONS;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__COMPUTED = WHERE_RULE_INDICATOR__COMPUTED;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__JOIN_CONDITIONS = WHERE_RULE_INDICATOR__JOIN_CONDITIONS;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__MAX_NUMBER_ROWS = WHERE_RULE_INDICATOR__MAX_NUMBER_ROWS;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__VALID_ROW = WHERE_RULE_INDICATOR__VALID_ROW;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__IN_VALID_ROW = WHERE_RULE_INDICATOR__IN_VALID_ROW;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__STORE_DATA = WHERE_RULE_INDICATOR__STORE_DATA;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__USER_COUNT = WHERE_RULE_INDICATOR__USER_COUNT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__MATCHING_VALUE_COUNT = WHERE_RULE_INDICATOR__MATCHING_VALUE_COUNT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__NOT_MATCHING_VALUE_COUNT = WHERE_RULE_INDICATOR__NOT_MATCHING_VALUE_COUNT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__UNIQUE_VALUES = WHERE_RULE_INDICATOR__UNIQUE_VALUES;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__DISTINCT_VALUE_COUNT = WHERE_RULE_INDICATOR__DISTINCT_VALUE_COUNT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__UNIQUE_VALUE_COUNT = WHERE_RULE_INDICATOR__UNIQUE_VALUE_COUNT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__DUPLICATE_VALUE_COUNT = WHERE_RULE_INDICATOR__DUPLICATE_VALUE_COUNT;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__VALUE_TO_FREQ = WHERE_RULE_INDICATOR__VALUE_TO_FREQ;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__VALUE = WHERE_RULE_INDICATOR__VALUE;
     ...
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR__DATATYPE = WHERE_RULE_INDICATOR__DATATYPE;

    /**
     * The number of structural features of the '<em>Where Rule Aide Indicator</em>' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
    int WHERE_RULE_AIDE_INDICATOR_FEATURE_COUNT = WHERE_RULE_INDICATOR_FEATURE_COUNT + 0;
    ...
    /**
     * Returns the meta object for class '{@link org.talend.dataquality.indicators.sql.WhereRuleAideIndicator <em>Where Rule Aide Indicator</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Where Rule Aide Indicator</em>'.
     * @see org.talend.dataquality.indicators.sql.WhereRuleAideIndicator
     * @generated
     */
    EClass getWhereRuleAideIndicator();
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '{@link org.talend.dataquality.indicators.sql.impl.WhereRuleAideIndicatorImpl <em>Where Rule Aide Indicator</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see org.talend.dataquality.indicators.sql.impl.WhereRuleAideIndicatorImpl
         * @see org.talend.dataquality.indicators.sql.impl.IndicatorSqlPackageImpl#getWhereRuleAideIndicator()
         * @generated
         */
        EClass WHERE_RULE_AIDE_INDICATOR = eINSTANCE.getWhereRuleAideIndicator();
