...
public class IndicatorSqlFactoryImpl extends EFactoryImpl implements IndicatorSqlFactory {
    ...
    public static IndicatorSqlFactory init() {
        try {
            IndicatorSqlFactory theIndicatorSqlFactory = (IndicatorSqlFactory) EPackage.Registry.INSTANCE
                    .getEFactory("http://dataquality.indicators.sql");
    ...
    public EObject create(EClass eClass) {
        ...
        case IndicatorSqlPackage.USER_DEF_INDICATOR:
            return createUserDefIndicator();
        case IndicatorSqlPackage.WHERE_RULE_INDICATOR:
            return createWhereRuleIndicator();
        case IndicatorSqlPackage.JAVA_USER_DEF_INDICATOR:
            return createJavaUserDefIndicator();
        default:
