...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Bin Low Frequency Indicator</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * </p>
 * 
 * @generated
 */
public class BinLowFrequencyIndicatorImpl extends FrequencyIndicatorImpl implements BinLowFrequencyIndicator {
     ...
     * @generated
     */
    protected BinLowFrequencyIndicatorImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return IndicatorsPackage.Literals.BIN_LOW_FREQUENCY_INDICATOR;
    }
    ...
    /**
     * 
     * if the bin parameter is set,look range name as a group label.
     * 
     * @param name
     * @return
     */
    ...
    public boolean finalizeComputation() {
        ...
        for (RangeRestriction range : ranges) {
            ...
            if (valueToFreq.get(rangeName) == null) {
                valueToFreq.put(rangeName, 0l);
            }
        }
        return super.finalizeComputation();
    }
