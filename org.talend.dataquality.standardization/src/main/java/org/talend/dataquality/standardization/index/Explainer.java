 ...
 * 
 * This is similarity scoring formula of lucene. Its purpose is to measure the similarity between a query and each
 * document that matches the query. The score is computed for each document (d) matching each term (t) in a query (q).
 * 
