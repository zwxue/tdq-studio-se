...
public final class ChartDatasetUtils {
     ...
     */
    public static Map<String, ValueAggregator> createXYZDatasets(ColumnSetMultiValueIndicator indicator, MeatadataColumn numericColumn) {

        final EList<MeatadataColumn> nominalColumns = indicator.getNominalColumns();
        final EList<MeatadataColumn> numericColumns = indicator.getNumericColumns();
    ...
    public static Map<String, DateValueAggregate> createGanttDatasets(ColumnSetMultiValueIndicator indicator, MeatadataColumn dateColumn) {

        final EList<MeatadataColumn> nominalColumns = indicator.getNominalColumns();
        final EList<MeatadataColumn> dateColumns = indicator.getDateColumns();
     ...
     */
    private static Map<String, ValueAggregator> fillDataset(final EList<MeatadataColumn> nominalColumns, final List<Object[]> listRows,
     ...
     * 
     */
    private static Map<String, DateValueAggregate> fillGanttDataset(final EList<MeatadataColumn> nominalColumns,
     ...
     * @return a key
     */
    private static String createKey(EList<MeatadataColumn> nominalColumns, int n) {
