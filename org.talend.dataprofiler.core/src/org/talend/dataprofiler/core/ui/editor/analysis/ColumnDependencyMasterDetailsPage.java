...
/**
 * This is a Master Detail Page for <a href="http://www.talendforge.org/bugs/view.php?id=8134">Functional Dependency Analysis</a>.
 * @author jet
 *
 */
public class ColumnDependencyMasterDetailsPage extends
    ...
    protected void createFormContent(IManagedForm managedForm) {
        ...
        form
                .setText(DefaultMessagesImpl
                        .getString("ColumnDependencyMasterDetailsPage.ColumnDependencyAnalysis")); //$NON-NLS-1$
        ...
        anaColumnCompareViewer = new AnalysisColumnCompareTreeViewer((AbstractAnalysisMetadataPage)this,  topComp, getColumnLeftSet(),getColumnRightSet(),DefaultMessagesImpl
	 ...
	 * @param title
	 */
	public ColumnDependencyMasterDetailsPage(FormEditor editor, String id,
			String title) {
	...
	protected void saveAnalysis() throws DataprofilerCoreException {
        ...
        if (columnListA.size() > 0) {
            TdDataProvider tdDataProvider = DataProviderHelper
                    .getTdDataProvider(columnListA.get(0));
	...
	private ReturnCode validator(List<Column> columnASet , List<Column> columnBSet){
	    ...
	    if(columnASet.size() == 0 || columnBSet.size() == 0){
	        return new  ReturnCode(
                    DefaultMessagesImpl
                    .getString("ColumnDependencyMasterDetailsPage.columnsBlankMessag"), false);
	    }
	    if(columnASet.size() != columnBSet.size()){
	        //two set must have equal number.
	        return new ReturnCode(
                    DefaultMessagesImpl
                    .getString("ColumnsComparisonMasterDetailsPage.columnsSameMessage"), false);
	    }
