...
public class ChartImageFactory {
    ...
    static ImageDescriptor createImage(EIndicatorChartType chartType, CategoryDataset dataset) {

        switch (chartType) {
        case FREQUENCE_STATISTICS:
            return createBarChart(chartType.getLiteral(), dataset);

        case PATTERN_MATCHING:
        case SQL_PATTERN_MATCHING:
            return createStacked3DBarChart(chartType.getLiteral(), dataset);
        ...
        case SUMMARY_STATISTICS:
            ...
            return create3DBarChart(chartType.getLiteral(), dataset, true);
    ...
    private static ImageDescriptor create3DBarChart(String titile, CategoryDataset dataset, boolean showLegend) {
    ...
    private static ImageDescriptor createBarChart(String titile, CategoryDataset dataset) {
    ...
    private static ImageDescriptor createBoxAndWhiskerChart(String title, BoxAndWhiskerCategoryDataset dataset) {
    ...
    private static ImageDescriptor createStacked3DBarChart(String titile, CategoryDataset dataset) {
