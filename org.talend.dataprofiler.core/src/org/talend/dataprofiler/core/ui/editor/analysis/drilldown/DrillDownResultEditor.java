...
public class DrillDownResultEditor extends EditorPart {
    ...
    public void createPartControl(Composite parent) {
        ...
        if (this.getEditorInput() instanceof DrillDownEditorInput) {
            Analysis analysis = ((DrillDownEditorInput) this.getEditorInput()).getAnalysis();
            Indicator indicator = ((DrillDownEditorInput) this.getEditorInput()).getCurrIndicator();
    ...
    private class DrillDownResultContentProvider implements IStructuredContentProvider {
        ...
        public Object[] getElements(Object inputElement) {
            if (inputElement instanceof DrillDownEditorInput) {
                currIndicator = ((DrillDownEditorInput) inputElement).getCurrIndicator();
                ...
                return analysisDataSet.getData().toArray();
            }
            return null;
        }
