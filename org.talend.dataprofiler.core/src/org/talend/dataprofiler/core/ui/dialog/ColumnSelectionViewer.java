...
//	boolean nonCareAboutRelation=false;
...
//	 protected void doCheckStateChanged(Object element,boolean isCheckRelation) {
//		 Widget item = findItem(element);
//		 if (item instanceof TreeItem) {
//			 TreeItem treeItem = (TreeItem) item;
//			 treeItem.setGrayed(false);
...
//		 if (setCheckedForTheElement(element,state)) {
//	            doCheckStateChanged(element,isCheckRelation);
//	            return true;
//	        }
//	        return false;
//	}
	 
//    public boolean setCheckedForTheElement(Object element, boolean state) {
...
//		if(elements.length>0&& elements[0] instanceof MDMXmlElementRepNode){
//			nonCareAboutRelation=true;
//		}
//		super.setCheckedElements(elements);
//		nonCareAboutRelation=false;
//        for (int i = 0; i < elements.length; i++) {
//            doCheckStateChanged(elements[i],isCheckRelation);
//        }
//	}
//
//	@Override
