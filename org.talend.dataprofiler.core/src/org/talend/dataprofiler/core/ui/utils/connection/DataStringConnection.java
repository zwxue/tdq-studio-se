...
//
// ============================================================================
package org.talend.dataprofiler.core.ui.utils.connection;
...
public class DataStringConnection {
    ...
    public String getUrlConnectionStr(DatabaseConnection conn) {
        ...
        getString(getDBTypes().indexOf(conn.getDatabaseType()), conn.getServerName(), conn.getUsername(), conn.getPassword(),
                conn.getPort(), conn.getSID(), conn.getFileFieldName(), conn.getDatasourceName(), conn.getDBRootPath(), conn
                        .getAdditionalParams());
        return getUrlConnectionStr();
    }
