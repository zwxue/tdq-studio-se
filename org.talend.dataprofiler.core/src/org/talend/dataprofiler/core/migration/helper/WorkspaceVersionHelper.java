...
public final class WorkspaceVersionHelper {
	...
	protected static Logger log = Logger
			.getLogger(WorkspaceVersionHelper.class);
	...
	public static IFile getVersionFile() {
		return ResourceManager.getLibrariesFolder().getFile(
	...
	public static ProductVersion getVesion() {
		...
		try {
			versionFile.refreshLocal(IResource.DEPTH_ONE,
	...
	public static void storeVersion() {
		...
		try {
			...
			// ~MOD mzhao 2009-06-12 feature 7242 Upgrade database version.
