...
public final class PluginConstant {
	...
	public static final String GREATER_OR_EQUAL = (Character
			.isDefined('\u2265')) ? "\u2265" : ">="; //$NON-NLS-1$ //$NON-NLS-2$

	public static final String DATAEXPLORER_PERSPECTIVE = DefaultMessagesImpl
			.getString("PluginConstant.dataExplorer"); //$NON-NLS-1$

	public static final String DATAPROFILER_PERSPECTIVE = DefaultMessagesImpl
			.getString("PluginConstant.dataProfiler"); //$NON-NLS-1$
