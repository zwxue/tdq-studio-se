/*******************************************************************************
 * Copyright (c) 2006, 2007, 2008 Obeo. All rights reserved. This program and the accompanying materials are made
...
public class ModelStructureMergeViewer extends TreeViewer {
    ...
    /**
     * Allows us to ignore a selection event in the content viewer if it is one caused by a selection event in the
     * structure viewer.
     */
     ...
     * @param compareConfiguration The configuration object.
     */
    ...
    /**
     * Returns the compare configuration of this viewer, or <code>null</code> if this viewer does not yet have a
     * configuration.
     * 
     ...
     * 
     * @param element Element we seek the {@link TreeItem} for.
    ...
    /**
     * initializer of this structure merge viewer. It sets the {@link LabelProvider label} and content provider for the
     * tree and creates the different needed listeners.
     * 
     * @param compareConfiguration Configuration of the underlying comparison.
     */
    private void initialize(CompareConfiguration compareConfiguration) {
        ...
        tree.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(SelectionEvent e) {
                final List<DiffElement> selectedElements = new ArrayList<DiffElement>(getTree().getSelection().length);
    ...
    /**
     * Listens to property change events on the compare configuration. Typically responds to selection change events in
     * the content viewer and preferences change.
     * 
     * @author <a href="mailto:laurent.goubet@obeo.fr">Laurent Goubet</a>
     */
        ...
        public void propertyChange(PropertyChangeEvent event) {
            if (event.getProperty().equals(EMFCompareConstants.PROPERTY_CONTENT_SELECTION)) {
                if (ignoreContentSelection)
                    ...
                    /*
                     * if we could not find the item, we need to expand the whole tree to try and get it. This is due to
                     * the lazy loading of the tree content.
                     */
                    if (item == null) {
    ...
    private class ModelStructureLabelProvider extends LabelProvider {
        ...
        /**
         * We use this generic label provider, but we want to customize some aspects that's why we choose to aggregate
         * it.
         */
        ...
        /**
         * Returns the name of the given {@link IFile}, delegates to {@link AdapterFactoryLabelProvider#getText(Object)}
