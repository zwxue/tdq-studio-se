...
public class EMFCompareUIPlugin extends AbstractUIPlugin {
    ...
    /** This plugin's ID. */
    public static final String PLUGIN_ID = "org.talend.emf.compare.ui"; //$NON-NLS-1$
    ...
    public void start(BundleContext context) throws Exception {
        super.start(context);
        EMFComparePlugin.getDefault().getPluginPreferences().setValue(EMFComparePreferenceKeys.PREFERENCES_KEY_SEARCH_WINDOW,
                getPreferenceStore().getInt(EMFComparePreferenceKeys.PREFERENCES_KEY_SEARCH_WINDOW));
        EMFComparePlugin.getDefault().getPluginPreferences().setValue(EMFComparePreferenceKeys.PREFERENCES_KEY_IGNORE_ID,
                getPreferenceStore().getBoolean(EMFComparePreferenceKeys.PREFERENCES_KEY_IGNORE_ID));
        EMFComparePlugin.getDefault().getPluginPreferences().setValue(EMFComparePreferenceKeys.PREFERENCES_KEY_IGNORE_XMIID,
