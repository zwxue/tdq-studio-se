...
public class ColumnFolderNode extends AbstractFolderNode {
    ...
    public ColumnFolderNode(INode parent, ITableInfo tableInfo) {
        super(parent, Messages.getString("DatabaseStructureView.node.Columns"), parent.getSession(), "column_folder"); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void loadChildren() {
        ...
        try {
            ...
            SQLExplorerPlugin.error(Messages.getString("ColumnFolderNode.NotCreatChildNodes", getName()), e); //$NON-NLS-1$
        }
    }
