...
/**
 * This is the item provider adapter for a {@link orgomg.cwmx.resource.express.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Relation_isTemp_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Relation_isTemp_feature", "_UI_Relation_type"),
                 ExpressPackage.Literals.RELATION__IS_TEMP,
                 true,
                 false,
                 false,
    ...
    protected void addPageSpacePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Relation_pageSpace_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Relation_pageSpace_feature", "_UI_Relation_type"),
                 ExpressPackage.Literals.RELATION__PAGE_SPACE,
                 true,
                 false,
                 false,
    ...
    protected void addReferenceDimensionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Relation_referenceDimension_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Relation_referenceDimension_feature", "_UI_Relation_type"),
                 ExpressPackage.Literals.RELATION__REFERENCE_DIMENSION,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addAggMapComponentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Relation_aggMapComponent_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Relation_aggMapComponent_feature", "_UI_Relation_type"),
                 ExpressPackage.Literals.RELATION__AGG_MAP_COMPONENT,
                 true,
                 false,
                 true,
                 null,
