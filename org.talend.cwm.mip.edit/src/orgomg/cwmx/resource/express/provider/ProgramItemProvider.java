...
/**
 * This is the item provider adapter for a {@link orgomg.cwmx.resource.express.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addReturnDimensionPropertyDescriptor(object);
        }
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Program_program_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Program_program_feature", "_UI_Program_type"),
                 ExpressPackage.Literals.PROGRAM__PROGRAM,
                 true,
                 false,
                 false,
    ...
    /**
     * This adds a property descriptor for the Return Dimension feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addReturnDimensionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Program_returnDimension_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Program_returnDimension_feature", "_UI_Program_type"),
                 ExpressPackage.Literals.PROGRAM__RETURN_DIMENSION,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
