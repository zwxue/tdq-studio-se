...
/**
 * This is the item provider adapter for a {@link orgomg.cwmx.resource.express.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Variable_storageType_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Variable_storageType_feature", "_UI_Variable_type"),
                 ExpressPackage.Literals.VARIABLE__STORAGE_TYPE,
                 true,
                 false,
                 false,
    ...
    protected void addPageSpacePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Variable_pageSpace_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Variable_pageSpace_feature", "_UI_Variable_type"),
                 ExpressPackage.Literals.VARIABLE__PAGE_SPACE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addWidthPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Variable_width_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Variable_width_feature", "_UI_Variable_type"),
                 ExpressPackage.Literals.VARIABLE__WIDTH,
                 true,
                 false,
                 false,
