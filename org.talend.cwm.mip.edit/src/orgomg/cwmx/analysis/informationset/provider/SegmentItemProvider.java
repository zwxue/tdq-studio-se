...
import orgomg.cwm.analysis.olap.provider.CubeItemProvider;
...
/**
 * This is the item provider adapter for a {@link orgomg.cwmx.analysis.informationset.Segment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SegmentItemProvider
    extends CubeItemProvider
    implements	
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Segment_rule_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Segment_rule_feature", "_UI_Segment_type"),
                 InformationsetPackage.Literals.SEGMENT__RULE,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(InformationsetPackage.Literals.SEGMENT__REGION_SEQUENCE);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (InformationsetPackage.Literals.SEGMENT__REGION_SEQUENCE,
