 ...
 * $Id$
 */
package orgomg.cwm.objectmodel.relationships.provider;
...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.objectmodel.relationships.Generalization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Generalization_child_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Generalization_child_feature", "_UI_Generalization_type"),
                 RelationshipsPackage.Literals.GENERALIZATION__CHILD,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addParentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Generalization_parent_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Generalization_parent_feature", "_UI_Generalization_type"),
                 RelationshipsPackage.Literals.GENERALIZATION__PARENT,
                 true,
                 false,
                 true,
                 null,
