...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.objectmodel.core.Stereotype} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StereotypeItemProvider
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addExtendedElementPropertyDescriptor(object);
        }
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Stereotype_baseClass_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Stereotype_baseClass_feature", "_UI_Stereotype_type"),
                 CorePackage.Literals.STEREOTYPE__BASE_CLASS,
                 true,
                 false,
                 false,
    ...
    /**
     * This adds a property descriptor for the Extended Element feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addExtendedElementPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Stereotype_extendedElement_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Stereotype_extendedElement_feature", "_UI_Stereotype_type"),
                 CorePackage.Literals.STEREOTYPE__EXTENDED_ELEMENT,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(CorePackage.Literals.STEREOTYPE__STEREOTYPE_CONSTRAINT);
            childrenFeatures.add(CorePackage.Literals.STEREOTYPE__REQUIRED_TAG);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (CorePackage.Literals.STEREOTYPE__STEREOTYPE_CONSTRAINT,
        ...
        newChildDescriptors.add
            (createChildParameter
                (CorePackage.Literals.STEREOTYPE__REQUIRED_TAG,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify =
            ...
            childFeature == CorePackage.Literals.STEREOTYPE__REQUIRED_TAG;
