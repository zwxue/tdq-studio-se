...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.objectmodel.behavioral.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Method_specification_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Method_specification_feature", "_UI_Method_type"),
                 BehavioralPackage.Literals.METHOD__SPECIFICATION,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(BehavioralPackage.Literals.METHOD__BODY);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (BehavioralPackage.Literals.METHOD__BODY,
