...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.objectmodel.behavioral.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 BehavioralPackage.Literals.OPERATION__IS_ABSTRACT,
                 true,
                 false,
                 false,
    ...
    protected void addCallActionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Operation_callAction_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Operation_callAction_feature", "_UI_Operation_type"),
                 BehavioralPackage.Literals.OPERATION__CALL_ACTION,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addMethodPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Operation_method_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Operation_method_feature", "_UI_Operation_type"),
                 BehavioralPackage.Literals.OPERATION__METHOD,
                 true,
                 false,
                 true,
                 null,
