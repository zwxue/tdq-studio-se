...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.objectmodel.behavioral.BehavioralFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BehavioralFeatureItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_BehavioralFeature_isQuery_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_BehavioralFeature_isQuery_feature", "_UI_BehavioralFeature_type"),
                 BehavioralPackage.Literals.BEHAVIORAL_FEATURE__IS_QUERY,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(BehavioralPackage.Literals.BEHAVIORAL_FEATURE__PARAMETER);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (BehavioralPackage.Literals.BEHAVIORAL_FEATURE__PARAMETER,
