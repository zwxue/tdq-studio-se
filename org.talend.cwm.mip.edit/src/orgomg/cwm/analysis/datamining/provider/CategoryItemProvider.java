...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.analysis.datamining.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Category_displayValue_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Category_displayValue_feature", "_UI_Category_type"),
                 DataminingPackage.Literals.CATEGORY__DISPLAY_VALUE,
                 true,
                 false,
                 false,
    ...
    protected void addPropertyPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Category_property_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Category_property_feature", "_UI_Category_type"),
                 DataminingPackage.Literals.CATEGORY__PROPERTY,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 DataminingPackage.Literals.CATEGORY__VALUE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
