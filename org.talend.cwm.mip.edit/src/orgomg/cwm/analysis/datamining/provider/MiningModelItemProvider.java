...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.analysis.datamining.MiningModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MiningModelItemProvider
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addMiningResultPropertyDescriptor(object);
        }
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 DataminingPackage.Literals.MINING_MODEL__FUNCTION,
                 true,
                 false,
                 false,
    ...
    protected void addAlgorithmPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_MiningModel_algorithm_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_MiningModel_algorithm_feature", "_UI_MiningModel_type"),
                 DataminingPackage.Literals.MINING_MODEL__ALGORITHM,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 DataminingPackage.Literals.MINING_MODEL__SETTINGS,
                 true,
                 false,
                 true,
                 null,
    ...
    /**
     * This adds a property descriptor for the Mining Result feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addMiningResultPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_MiningModel_miningResult_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_MiningModel_miningResult_feature", "_UI_MiningModel_type"),
                 DataminingPackage.Literals.MINING_MODEL__MINING_RESULT,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DataminingPackage.Literals.MINING_MODEL__INPUT_SPEC);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (DataminingPackage.Literals.MINING_MODEL__INPUT_SPEC,
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify =
            ...
            childFeature == DataminingPackage.Literals.MINING_MODEL__INPUT_SPEC ||
