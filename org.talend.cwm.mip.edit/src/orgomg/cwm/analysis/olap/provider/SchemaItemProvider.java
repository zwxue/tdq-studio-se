...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.analysis.olap.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(OlapPackage.Literals.SCHEMA__CUBE);
            childrenFeatures.add(OlapPackage.Literals.SCHEMA__DIMENSION);
            childrenFeatures.add(OlapPackage.Literals.SCHEMA__DEPLOYMENT_GROUP);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (OlapPackage.Literals.SCHEMA__CUBE,
        ...
        newChildDescriptors.add
            (createChildParameter
                (OlapPackage.Literals.SCHEMA__DIMENSION,
                 OlapFactory.eINSTANCE.createDimension()));

        newChildDescriptors.add
            (createChildParameter
                (OlapPackage.Literals.SCHEMA__DEPLOYMENT_GROUP,
