...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.analysis.transformation.TransformationActivity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransformationActivityItemProvider
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addWarehouseActivityPropertyDescriptor(object);
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 TransformationPackage.Literals.TRANSFORMATION_ACTIVITY__CREATION_DATE,
                 true,
                 false,
                 false,
    ...
    /**
     * This adds a property descriptor for the Warehouse Activity feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addWarehouseActivityPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_TransformationActivity_warehouseActivity_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_TransformationActivity_warehouseActivity_feature", "_UI_TransformationActivity_type"),
                 TransformationPackage.Literals.TRANSFORMATION_ACTIVITY__WAREHOUSE_ACTIVITY,
                 true,
                 false,
                 true,
                 null,
    ...
    protected void addExecutionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_TransformationActivity_execution_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_TransformationActivity_execution_feature", "_UI_TransformationActivity_type"),
                 TransformationPackage.Literals.TRANSFORMATION_ACTIVITY__EXECUTION,
                 true,
                 false,
                 true,
                 null,
