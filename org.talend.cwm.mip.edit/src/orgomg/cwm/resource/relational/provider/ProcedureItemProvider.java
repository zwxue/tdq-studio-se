...
import orgomg.cwm.objectmodel.behavioral.provider.MethodItemProvider;
import orgomg.cwm.objectmodel.core.provider.Cwm_mipEditPlugin;
import orgomg.cwm.resource.relational.Procedure;
import orgomg.cwm.resource.relational.RelationalPackage;

/**
 * This is the item provider adapter for a {@link orgomg.cwm.resource.relational.Procedure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcedureItemProvider
    extends MethodItemProvider
    implements	
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Procedure_type_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Procedure_type_feature", "_UI_Procedure_type"),
                 RelationalPackage.Literals.PROCEDURE__TYPE,
                 true,
                 false,
                 false,
