...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.resource.relational.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addCheckOptionPropertyDescriptor(object);
        }
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_View_isReadOnly_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_View_isReadOnly_feature", "_UI_View_type"),
                 RelationalPackage.Literals.VIEW__IS_READ_ONLY,
                 true,
                 false,
                 false,
    ...
    /**
     * This adds a property descriptor for the Check Option feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addCheckOptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_View_checkOption_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_View_checkOption_feature", "_UI_View_type"),
                 RelationalPackage.Literals.VIEW__CHECK_OPTION,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(RelationalPackage.Literals.VIEW__QUERY_EXPRESSION);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (RelationalPackage.Literals.VIEW__QUERY_EXPRESSION,
