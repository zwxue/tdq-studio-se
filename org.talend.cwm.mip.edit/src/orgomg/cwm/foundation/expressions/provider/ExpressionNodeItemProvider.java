...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.foundation.expressions.ExpressionNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionNodeItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ExpressionNode_type_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ExpressionNode_type_feature", "_UI_ExpressionNode_type"),
                 ExpressionsPackage.Literals.EXPRESSION_NODE__TYPE,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ExpressionsPackage.Literals.EXPRESSION_NODE__EXPRESSION);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_ExpressionNode_type");
    }
