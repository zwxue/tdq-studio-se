...
/**
 * This is the item provider adapter for a {@link orgomg.cwm.foundation.businessinformation.Email} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmailItemProvider
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addEmailTypePropertyDescriptor(object);
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 BusinessinformationPackage.Literals.EMAIL__EMAIL_ADDRESS,
                 true,
                 false,
                 false,
    ...
    /**
     * This adds a property descriptor for the Email Type feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    protected void addEmailTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Email_emailType_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Email_emailType_feature", "_UI_Email_type"),
                 BusinessinformationPackage.Literals.EMAIL__EMAIL_TYPE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addContactPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Email_contact_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Email_contact_feature", "_UI_Email_type"),
                 BusinessinformationPackage.Literals.EMAIL__CONTACT,
                 true,
                 false,
                 true,
                 null,
