...
/**
 * a category in exchange.<p>
 * take <a url='http://www.talendforge.org/exchange/top/index.php?cid=1'><code>regex</code></a> for example.
 * It contain name, counter and component.
 * @author gyichao
 *
 */
public interface IEcosCategory {
	 ...
	 * @return {@linkplain IEcosComponent} in {@linkplain List}. May be empty list, can not be null
	 */
