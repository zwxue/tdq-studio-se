 ...
 * <ul>
 *   <li>{@link org.talend.dataquality.indicators.impl.AvgLengthWithNullIndicatorImpl#getSumLength <em>Sum Length</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AvgLengthWithNullIndicatorImpl extends LengthIndicatorImpl implements AvgLengthWithNullIndicator {
    ...
    public void setSumLength(Double newSumLength) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IndicatorsPackage.AVG_LENGTH_WITH_NULL_INDICATOR__SUM_LENGTH, oldSumLength, sumLength));
    }
