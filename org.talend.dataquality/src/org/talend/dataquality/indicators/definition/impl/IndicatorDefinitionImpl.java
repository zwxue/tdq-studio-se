 ...
 *   <li>{@link org.talend.dataquality.indicators.definition.impl.IndicatorDefinitionImpl#getIndicatorDefinitionParameter <em>Indicator Definition Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IndicatorDefinitionImpl extends ModelElementImpl implements IndicatorDefinition {
    ...
    /**
     * The cached value of the '{@link #getIndicatorDefinitionParameter() <em>Indicator Definition Parameter</em>}' containment reference list.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    public EList<IndicatorDefinitionParameter> getIndicatorDefinitionParameter() {
        if (indicatorDefinitionParameter == null) {
            indicatorDefinitionParameter = new EObjectContainmentEList<IndicatorDefinitionParameter>(IndicatorDefinitionParameter.class, this, DefinitionPackage.INDICATOR_DEFINITION__INDICATOR_DEFINITION_PARAMETER);
        }
