...
public class IndicatorSqlAdapterFactory extends AdapterFactoryImpl {
    ...
    protected IndicatorSqlSwitch<Adapter> modelSwitch =
        new IndicatorSqlSwitch<Adapter>() {
            @Override
            public Adapter caseSqlIndicator(SqlIndicator object) {
                return createSqlIndicatorAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.dataquality.indicators.sql.SqlIndicator <em>Sql Indicator</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createSqlIndicatorAdapter() {
        return null;
    }
