...
public class IndicatorSqlSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case IndicatorSqlPackage.SQL_INDICATOR: {
                SqlIndicator sqlIndicator = (SqlIndicator)theEObject;
                T result = caseSqlIndicator(sqlIndicator);
                if (result == null) result = caseIndicator(sqlIndicator);
                if (result == null) result = caseModelElement(sqlIndicator);
                if (result == null) result = caseElement(sqlIndicator);
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Sql Indicator</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Sql Indicator</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseSqlIndicator(SqlIndicator object) {
        return null;
    }
