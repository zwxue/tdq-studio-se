...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Record Matching Indicator</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
...
public interface RecordMatchingIndicator extends ColumnSetMultiValueIndicator {
    /**
     * Returns the value of the '<em><b>Group Size2group Frequency</b></em>' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * contains the frequency of groups of similar records.  The key is the size of the groups. The value is the number of groups with that size.
     * <!-- end-model-doc -->
    ...
    /**
     * Returns the value of the '<em><b>Matched Record Count</b></em>' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * number of records that have matched (duplicate) with a quality value higher than the confidence threshold.
     * <!-- end-model-doc -->
    ...
    /**
     * Returns the value of the '<em><b>Suspect Record Count</b></em>' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * number of records that have matched (duplicate) with a quality value higher than the confidence threshold.
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Built In Match Rule Definition</em>' containment reference isn't clear,
