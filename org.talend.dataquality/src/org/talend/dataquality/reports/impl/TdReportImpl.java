...
public class TdReportImpl extends ReportImpl implements TdReport {
    ...
    public void setLastExecutionDate(Date newLastExecutionDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ReportsPackage.TD_REPORT__LAST_EXECUTION_DATE,
                    oldLastExecutionDate, lastExecutionDate));
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case ReportsPackage.TD_REPORT__LAST_EXECUTION_DATE:
            return LAST_EXECUTION_DATE_EDEFAULT == null ? lastExecutionDate != null : !LAST_EXECUTION_DATE_EDEFAULT
                    .equals(lastExecutionDate);
        case ReportsPackage.TD_REPORT__ANALYSIS_MAP:
