...
public class CategoryAdapterFactory extends AdapterFactoryImpl {
    ...
    protected CategorySwitch<Adapter> modelSwitch =
        new CategorySwitch<Adapter>() {
            ...
            @Override
            public Adapter caseAnalysisCategories(AnalysisCategories object) {
                return createAnalysisCategoriesAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.dataquality.analysis.category.AnalysisCategory <em>Analysis Category</em>}'.
     * <!-- begin-user-doc -->
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.dataquality.analysis.category.AnalysisCategories <em>Analysis Categories</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createAnalysisCategoriesAdapter() {
        return null;
    }
