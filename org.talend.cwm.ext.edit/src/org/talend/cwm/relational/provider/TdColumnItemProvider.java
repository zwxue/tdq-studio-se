...
import orgomg.cwm.resource.relational.provider.ColumnItemProvider;
 ...
 * @generated
 */
public class TdColumnItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_TdColumn_javaType_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_TdColumn_javaType_feature", "_UI_TdColumn_type"),
                 RelationalPackage.Literals.TD_COLUMN__JAVA_TYPE,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(RelationalPackage.Literals.TD_COLUMN__SQL_DATA_TYPE);
        }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/TdColumn"));
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(TdColumn.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (RelationalPackage.Literals.TD_COLUMN__SQL_DATA_TYPE,
