...
import org.talend.cwm.xml.util.XmlAdapterFactory;
...
public class XmlItemProviderAdapterFactory extends XmlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
     ...
     */
    public void dispose() {
        if (tdXMLElementItemProvider != null) tdXMLElementItemProvider.dispose();
        if (tdXMLContentItemProvider != null) tdXMLContentItemProvider.dispose();
        if (tdXMLDocumentItemProvider != null) tdXMLDocumentItemProvider.dispose();
    }
